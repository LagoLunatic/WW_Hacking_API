...
// undefined J3DDeformData__deform(J3DDeformData * this, J3DVertexBuffer * pBuffer);
...
// undefined J2DPicture__drawSelf(J2DPicture * this, float x, float y, float * param_3);
...
// undefined f_op_msg_mng__fopMsgM_setPaneData(fopMsgM_pane_class * pPane, J2DScreen * pScreen, int fourcc);
...
// cM3dGPla * cBgS__GetTriPla(cBgS * this, int bg_index, int poly_index);
...
// int mDoExt_btkAnm__init(mDoExt_btkAnm * this, J3DMaterialTable * i_matTbl, J3DAnmTextureSRTKey * i_btk, bool bStartPlaying, J3DFrameCtrl__LoopMode loopMode, float param_5, short param_6, short param_7, bool i_modify, int param_9);
...
// void J2DPane__J2DPane(J2DPane * this, J2DPane * pParentPane, JSURandomInputStream * pStream);
...
// void * JKernel__operator_new(ulong size, JKRHeap * heap, undefined4 align);
