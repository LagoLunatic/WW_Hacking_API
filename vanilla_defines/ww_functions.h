...
undefined4 * createAppend(ulong parameters, cXyz * pPos, int roomNo, csXyz * angle, cXyz * scale, char subtype, uint parentSomething);
...
undefined fopAcM_createChild(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined param_5, undefined param_6, undefined param_7, undefined param_8, undefined4 param_9);
...
undefined fopAcM_entrySolidHeap();
...
// void * dRes_control_c__getRes(char * param_1, char * param_2, dRes_info_c * param_3, int param_4);
