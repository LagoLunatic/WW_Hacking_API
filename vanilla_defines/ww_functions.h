...
void J2DOrthoGraph__J2DOrthoGraph_1(J2DOrthoGraph * this, float param_1, float param_2, float param_3, float param_4, float param_5, float param_6);
...
undefined m_Do_MemCardRWmng__mDoMemCdRWm_TestCheckSumGameData(card_savedata * param_1);
