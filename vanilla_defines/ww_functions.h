...
int fopAcM_createShopItem(cXyz * param_1, ulong itemNo, csXyz * param_3, int param_4, cXyz * param_5, undefined * param_6);
...
undefined4 dComIfGd_setSimpleShadow2(cXyz * param_1, double param_2, double param_3, cBgS_PolyInfo * param_4, short param_5, double param_6, _GXTexObj * param_7);
...
int dComIfGd_setShadow(ulong param_1, byte param_2, J3DModel * pModel, cXyz * param_4, double param_5, double param_6, double param_7, double param_8, ushort * param_9, dKy_tevstr_c * param_10, short param_11, double param_12, _GXTexObj * param_13);
...
uint d_drawlist__setShadowRealMtx(MTX34 * pDst, MTX34 * param_2, MTX34 * param_3, cXyz * param_4, cXyz * param_5, float param_6, float param_7, dDlst_shadowPoly_c * param_8, float param_9);
...
undefined dDlst_shadowReal_c__set2(dDlst_shadowReal_c * this, ulong param_1, char param_2, J3DModel * pModel, cXyz * param_4, float param_5, float param_6, dKy_tevstr_c * param_7);
...
void dCcS__SetAtTgGObjInf(dCcS * this, bool param_1, bool param_2, cCcD_Obj * pAt, cCcD_Obj * pTg, dCcD_GObjInf * pAtInf, dCcD_GObjInf * pTgInf, dCcD_Stts * pAtStts, dCcD_Stts * pTgStts, dCcD_GStts * pAtGStts, dCcD_GStts * pTgGStts, cXyz * pCrossPos);
...
undefined daPy_lk_c__setAtParam(daPy_lk_c * this, cCcD_Obj__DamageTypes damageType, int damageAmount, dCcG_At_Spl spl, byte seType, byte hitmarkType, daPy_lk_c__PlayerAttackState attackState, float cpsRadius);
...
double J3DGraphBase__J3DCalcZValue(MTX44 * param_1, cXyz * param_2);
