...
undefined4 FUN_800033a8(int param_1, uint param_2, uint param_3);
undefined FUN_800033d8(int param_1, uint param_2, uint param_3);
...
undefined m_Do_audio__mDoAud_setSceneName(undefined4 pSceneName, undefined4 startCode, undefined4 layerNo);
...
void mDoGph_gInf_c__free(void);
undefined mDoGph_gInf_c__fadeOut(float param_1, _GXColor * param_2);
void mDoGph_gInf_c__onBlure(void);
void mDoGph_gInf_c__onBlure_1(MTX34 * param_1);
void mDoGph_gInf_c__fadeOut_1(float param_1);
...
void mDoGph_gInf_c__calcMonotone(mDoGph_gInf_c * this);
...
void m_Do_graphic__drawDepth(camera_class * pView, dDlst_window_c * pViewPort, uint param_3);
undefined dStage_roomDt_c__getFileListInfo(dStage_roomDt_c * this);
undefined m_Do_graphic__motionBlure(view_class * pView);
...
void J2DOrthoGraph__J2DOrthoGraph_destructor(J2DOrthoGraph * this, short flag);
...
undefined mDoMtx_lookAt(undefined4 pDst, undefined4 param_2, undefined4 param_3, undefined4 param_4);
void cXyz__cXyz_destructor(cXyz * this);
void mDoMtx_lookAt_1(MTX34 * param_1, cXyz * pEye, cXyz * pCenter, cXyz * pUp, int bank);
...
undefined mDoExt_setJ3DData(MTX34 * pDst, J3DTransformInfo * pInfo, undefined4 param_3);
...
int mDoExt_bpkAnm__init_1(mDoExt_bpkAnm * this, EVP_PKEY_CTX * ctx);
...
undefined mDoExt_bpkAnm__entry_1(mDoExt_bpkAnm * this, J3DMaterialTable * param_1, float param_2);
...
int mDoExt_btpAnm__init_1(mDoExt_btpAnm * this, EVP_PKEY_CTX * ctx);
void J3DTexNoAnm__J3DTexNoAnm_destructor(J3DTexNoAnm * this);
void J3DTexNoAnm__J3DTexNoAnm(J3DTexNoAnm * this);
undefined mDoExt_btpAnm__entry_1(mDoExt_btpAnm * this, J3DMaterialTable * param_1, short param_2);
int mDoExt_btkAnm__init(mDoExt_btkAnm * this, J3DModelData * pModelData, J3DAnmTextureSRTKey * pAnm, bool bDoInit, J3DFrameCtrl__LoopMode loopMode, float speed, short start, short end, bool i_modify, int sound);
undefined mDoExt_btkAnm__entry(mDoExt_btkAnm * this, J3DModelData * param_1, float param_2);
int mDoExt_btkAnm__init_1(mDoExt_btkAnm * this, J3DMaterialTable * i_matTbl, J3DAnmTextureSRTKey * i_btk, bool bStartPlaying, J3DFrameCtrl__LoopMode loopMode, float param_5, short param_6, short param_7, bool i_modify, int param_9);
...
undefined mDoExt_btkAnm__entry_1(mDoExt_btkAnm * this, J3DMaterialTable * param_1, float param_2);
...
int mDoExt_brkAnm__init_1(mDoExt_brkAnm * this, J3DMaterialTable * pMatTbl, J3DAnmTevRegKey * pRegKey, int param_3, int param_4, float param_5, short param_6, short param_7, bool i_modify, int param_9);
...
undefined mDoExt_brkAnm__entry_1(mDoExt_brkAnm * this, J3DMaterialTable * param_1, float param_2);
...
undefined mDoExt_backupMaterial_c__create_1(mDoExt_backupMaterial_c * this, ushort param_1);
...
undefined mDoExt_invisibleModel__updateDL_1(mDoExt_invisibleModel * this, mDoExt_McaMorf * param_1);
...
JKRSolidHeap * mDoExt_createSolidHeapToCurrent(undefined4 maxHeapSize, JKRHeap * param_2, undefined4 param_3, undefined1 param_4);
...
mDoExt_McaMorf * mDoExt_McaMorf__mDoExt_McaMorf(mDoExt_McaMorf * this, ushort param_1, J3DModelData * pModelData, mDoExt_McaMorfCallBack1_c * param_3, mDoExt_McaMorfCallBack2_c * param_4, J3DAnmTransformKey * pAnmRes, J3DFrameCtrl__LoopMode loopMode, float speed, int startFrame, int duration, int bUseSound, void * pSoundRes, ulong param_12, ulong param_13);
void J3DFrameCtrl__J3DFrameCtrl_destructor(J3DFrameCtrl * this);
undefined mDoExt_McaMorf__calc_vtbl_cb(mDoExt_McaMorf * this, ushort idx);
undefined mDoExt_McaMorf__setAnm(mDoExt_McaMorf * this, J3DAnmTransform * pAnimRes, int loopMode, float morf, float speed, float startFrame, float duration, void * pSoundAnimRes);
undefined mDoExt_McaMorf__setMorf(mDoExt_McaMorf * this, float param_1);
undefined mDoExt_McaMorf__play(mDoExt_McaMorf * this, cXyz * pPos, ulong param_2, sbyte param_3);
undefined mDoExt_McaMorf__update(mDoExt_McaMorf * this);
undefined mDoExt_McaMorf__updateDL(mDoExt_McaMorf * this);
undefined mDoExt_McaMorf__updateDL_1(mDoExt_McaMorf * this, J3DMaterialTable * param_1);
undefined mDoExt_McaMorf__entry(mDoExt_McaMorf * this);
undefined mDoExt_McaMorf__entryDL(mDoExt_McaMorf * this);
undefined mDoExt_McaMorf__entryDL_1(mDoExt_McaMorf * this, J3DMaterialTable * param_1);
undefined mDoExt_McaMorf__calc(mDoExt_McaMorf * this);
undefined mDoExt_McaMorf__stopZelAnime(mDoExt_McaMorf * this);
void mDoExt_McaMorf2__mDoExt_McaMorf2(mDoExt_McaMorf2 * this, int param_1, J3DModelData * pModelData, mDoExt_McaMorfCallBack1_c * pCB1, mDoExt_McaMorfCallBack2_c * pCB2, J3DAnmTransform * pAnm1, J3DAnmTransform * pAnm2, int param_7, float param_8, int param_9, int param_10, int param_11, void * param_12, ulong param_13, ulong param_14);
...
undefined mDoExt_McaMorf2__calc_1(mDoExt_McaMorf2 * this);
...
undefined mDoExt_3DlineMat0_c__update_1(mDoExt_3DlineMat0_c * this, ushort param_1, _GXColor * param_2, dKy_tevstr_c * param_3);
int mDoExt_3DlineMat1_c__init(mDoExt_3DlineMat1_c * this, ushort numLines, ushort numSegments, ResTIMG * pImg, int param_4);
...
undefined mDoExt_3DlineMat1_c__update_1(mDoExt_3DlineMat1_c * this, ushort param_1, _GXColor * param_2, dKy_tevstr_c * param_3);
...
undefined J3DMtxCalcMayaAnm__calc_1(J3DMtxCalcMayaAnm * this, ushort param_1);
undefined J3DMtxCalcMayaAnm__calc_2(J3DMtxCalcMayaAnm * this, ushort param_1);
void J3DMtxCalcMayaAnm__J3DMtxCalcMayaAnm_destructor_1(J3DMtxCalcMayaAnm * this);
undefined mDoExt_MtxCalcAnmBlendTbl__calc_1(mDoExt_MtxCalcAnmBlendTbl * this, ushort param_1);
...
int J3DMtxCalcMaya__init_1(J3DMtxCalcMaya * this, EVP_PKEY_CTX * ctx);
undefined mDoExt_MtxCalcAnmBlendTblOld__calc_1(mDoExt_MtxCalcAnmBlendTblOld * this, ushort param_1);
undefined J3DMtxCalcMaya__calcTransform_1(J3DMtxCalcMaya * this, ushort param_1, J3DTransformInfo * param_2);
undefined J3DMtxCalcBasic__recursiveCalc_1(J3DMtxCalcBasic * this, J3DNode * param_1);
int J3DMtxCalcMaya__init_2(J3DMtxCalcMaya * this, EVP_PKEY_CTX * ctx);
undefined mDoExt_McaMorf__calc_2(mDoExt_McaMorf * this, ushort param_1);
undefined J3DMtxCalcMaya__calcTransform_2(J3DMtxCalcMaya * this, ushort param_1, J3DTransformInfo * param_2);
undefined J3DMtxCalcBasic__recursiveCalc_2(J3DMtxCalcBasic * this, J3DNode * param_1);
int J3DMtxCalcMaya__init_3(J3DMtxCalcMaya * this, EVP_PKEY_CTX * ctx);
undefined mDoExt_McaMorf2__calc_2(mDoExt_McaMorf2 * this, ushort param_1);
undefined J3DMtxCalcMaya__calcTransform_3(J3DMtxCalcMaya * this, ushort param_1, J3DTransformInfo * param_2);
undefined J3DMtxCalcBasic__recursiveCalc_3(J3DMtxCalcBasic * this, J3DNode * param_1);
int J3DMtxCalcMaya__init_4(J3DMtxCalcMaya * this, EVP_PKEY_CTX * ctx);
undefined m_Do_lib__mDoLib_setResTimgObj(ResTIMG * pResTIMG, undefined4 pTex, long param_3, GXTlutObj * param_4);
undefined mDoLib_clipper__setup(float fovy, float aspect, float near, float far);
...
undefined m_Do_dvd_thread__my_DVDConvertPathToEntrynum(undefined4 pFilePath);
...
void mDoDvdThd_toMainRam_c__mDoDvdThd_toMainRam_c(mDoDvdThd_toMainRam_c * this, byte direction);
...
undefined mDoMemCd_Ctrl_c__save(mDoMemCd_Ctrl_c * this, void * data, uint len, uint offset);
...
mDoMemCd_Ctrl_status mDoMemCd_Ctrl_c__getStatus(mDoMemCd_Ctrl_c * this, ulong param_1);
undefined mDoMemCd_Ctrl_c__format(mDoMemCd_Ctrl_c * this);
undefined mDoMemCd_Ctrl_c__FormatSync(mDoMemCd_Ctrl_c * this);
void mDoMemCd_Ctrl_c__attach(mDoMemCd_Ctrl_c * this, char * filename, ulong param_3, void * param_4);
...
mDoMemCd_Ctrl_status mDoMemCd_Ctrl_c__checkspace(mDoMemCd_Ctrl_c * this);
undefined mDoMemCd_Ctrl_c__setCardState(mDoMemCd_Ctrl_c * this, card_errors param_1);
undefined m_Do_MemCard__mDoMemCd_main();
undefined m_Do_MemCard____sinit_m_Do_MemCard_cpp();
undefined m_Do_MemCardRWmng__mDoMemCdRWm_Store(CARDFileInfo * pInf, undefined4 data, undefined4 size);
undefined m_Do_MemCardRWmng__mDoMemCdRWm_Restore(CARDFileInfo * file, undefined4 dest, undefined4 data_length);
undefined m_Do_MemCardRWmng__mDoMemCdRWm_BuildHeader(card_savebuffer * param_1);
undefined m_Do_MemCardRWmng__mDoMemCdRWm_SetCardStat();
undefined m_Do_MemCardRWmng__mDoMemCdRWm_CheckCardStat(CARDFileInfo * file);
undefined m_Do_MemCardRWmng__mDoMemCdRWm_CalcCheckSum(undefined4 pBuf, undefined4 size);
...
undefined m_Do_MemCardRWmng__mDoMemCdRWm_CalcCheckSumGameData(undefined4 pData, undefined4 size);
undefined m_Do_MemCardRWmng__mDoMemCdRWm_TestCheckSumGameData(card_savedata * pData);
...
undefined c_damagereaction__ice_bg_check(enemyice * pIce);
...
undefined c_damagereaction__enemy_piyo_set(fopAc_ac_c * pActor);
...
undefined c_damagereaction__dr_body_bg_check(damagereaction * this);
...
undefined c_damagereaction__dr_joint_bg_check(damagereaction * this);
void dBgS_ObjGndChk_Yogan__dBgS_ObjGndChk_Yogan_destructor(dBgS_ObjGndChk_Yogan * this);
undefined c_damagereaction__kado_check(damagereaction * this);
undefined c_damagereaction__hang_ang_get(damagereaction * this);
undefined c_damagereaction__dr_damage_set(damagereaction * this);
undefined c_damagereaction__dr_damage_anime(damagereaction * this);
undefined c_damagereaction__dr_matrix_set(damagereaction * this);
undefined c_damagereaction__damage_reaction(damagereaction * this);
undefined c_damagereaction____sinit_c_damagereaction_cpp();
void cBgS_LinChk__cBgS_LinChk_destructor_1(cBgS_LinChk * this);
void dBgS_Chk__dBgS_Chk_destructor_1(dBgS_Chk * this);
void dBgS_LinChk__dBgS_LinChk_destructor_1(dBgS_LinChk * this);
void dBgS_LinChk__dBgS_LinChk_destructor_2(dBgS_LinChk * this);
void dBgS_LinChk__dBgS_LinChk_destructor_3(dBgS_LinChk * this);
void dBgS_GndChk__dBgS_GndChk_destructor_1(dBgS_GndChk * this);
void dBgS_GndChk__dBgS_GndChk_destructor_2(dBgS_GndChk * this);
void dBgS_GndChk__dBgS_GndChk_destructor_3(dBgS_GndChk * this);
void dBgS_ObjGndChk__dBgS_ObjGndChk_destructor_1(dBgS_ObjGndChk * this);
void dBgS_ObjGndChk__dBgS_ObjGndChk_destructor_2(dBgS_ObjGndChk * this);
void dBgS_ObjGndChk__dBgS_ObjGndChk_destructor_3(dBgS_ObjGndChk * this);
void dBgS_ObjGndChk_Spl__dBgS_ObjGndChk_Spl_destructor_1(dBgS_ObjGndChk_Spl * this);
void dBgS_ObjGndChk_Spl__dBgS_ObjGndChk_Spl_destructor_2(dBgS_ObjGndChk_Spl * this);
void dBgS_ObjGndChk_Spl__dBgS_ObjGndChk_Spl_destructor_3(dBgS_ObjGndChk_Spl * this);
void cBgS_GndChk__cBgS_GndChk_destructor_1(cBgS_GndChk * this);
void dBgS_ObjGndChk_Yogan__dBgS_ObjGndChk_Yogan_destructor_1(dBgS_ObjGndChk_Yogan * this);
void dBgS_ObjGndChk_Yogan__dBgS_ObjGndChk_Yogan_destructor_2(dBgS_ObjGndChk_Yogan * this);
void dBgS_ObjGndChk_Yogan__dBgS_ObjGndChk_Yogan_destructor_3(dBgS_ObjGndChk_Yogan * this);
undefined c_dylink__cCc_Init();
undefined c_dylink__cDyl_IsLinked();
int c_dylink__cDyl_Unlink(ushort param_1, char * param_2);
undefined4 c_dylink__cDyl_LinkASync(ushort profName);
...
undefined fopAc_IsDelete(fopAc_ac_c * this);
int fopAc_Delete(fopAc_ac_c * this);
int fopAc_Create(fopAc_ac_c * this);
undefined fopAcIt_Executor();
...
undefined4 fopAcM_create_1(char * param_1, ulong param_2, cXyz * param_3, int param_4, csXyz * param_5, cXyz * param_6, undefined * param_7);
fopAc_ac_c * fopAcM_fastCreate(short actorID, ulong parameters, cXyz * pPos, int roomNo, csXyz * pAngle, cXyz * pScale, byte subtype, pointer pCallBack, void * pCallBackUserData);
undefined fopAcM_fastCreate_1();
...
int fopAcM_createChild_1(char * param_1, undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8);
...
undefined fopAcM_createChildFromOffset_1();
...
void fopAcM_posMove(fopAc_ac_c * pActor, cXyz * pAddVel);
void fopAcM_posMoveF(fopAc_ac_c * param_1, cXyz * param_2);
undefined fopAcM_searchActorAngleY(fopAc_ac_c * param_1, fopAc_ac_c * param_2);
short fopAcM_seenActorAngleY(fopAc_ac_c * param_1, fopAc_ac_c * param_2);
double fopAcM_searchActorDistance(fopAc_ac_c * actor1, fopAc_ac_c * actor2);
undefined fopAcM_searchActorDistance2(fopAc_ac_c * actor1, fopAc_ac_c * actor2);
undefined fopAcM_searchActorDistanceXZ(fopAc_ac_c * actor1, fopAc_ac_c * actor2);
undefined fopAcM_searchActorDistanceXZ2(fopAc_ac_c * actor1, fopAc_ac_c * actor2);
...
undefined4 fopAcM_cullingCheck(fopAc_ac_c * pActor);
...
undefined fopAcM_orderChangeEvent_1();
undefined fopAcM_orderChangeEventId();
undefined fopAcM_orderChangeEventId_1();
...
void fopAc_cullSizeBox__fopAc_cullSizeBox_2(fopAc_cullSizeBox * this, cXyz * param_1, cXyz * param_2);
void l_HIO__l_HIO_destructor(l_HIO * this);
void dBgS_WtrChk__dBgS_WtrChk_destructor_1(dBgS_WtrChk * this);
void dBgS_WtrChk__dBgS_WtrChk_destructor_2(dBgS_WtrChk * this);
void dBgS_WtrChk__dBgS_WtrChk_destructor_3(dBgS_WtrChk * this);
void dBgS_SplGrpChk__dBgS_SplGrpChk_destructor_1(dBgS_SplGrpChk * this);
void dBgS_SplGrpChk__dBgS_SplGrpChk_destructor_2(dBgS_SplGrpChk * this);
void dBgS_SplGrpChk__dBgS_SplGrpChk_destructor_3(dBgS_SplGrpChk * this);
...
undefined f_op_camera__fopCam_Create(camera_class * param_1);
int f_op_camera_mng__fopCamM_GetParam(camera_class * param_1);
...
undefined f_op_view__fopVw_Execute(view_class * param_1);
undefined f_op_view__fopVw_IsDelete();
undefined f_op_view__fopVw_Delete(view_class * param_1);
undefined f_op_view__fopVw_Create(view_class * param_1);
...
undefined f_op_msg__fopMsg_Execute(msg_class * this);
undefined f_op_msg__fopMsg_IsDelete(msg_class * param_1);
undefined f_op_msg__fopMsg_Delete(msg_class * param_1);
undefined f_op_msg__fopMsg_Create(msg_class * this);
void f_op_kankyo_mng__fopKyM_SearchByID(uint param_1);
fopKyM_prm_class * f_op_kankyo_mng__fopKyM_CreateAppend(void);
undefined4 * f_op_kankyo_mng__createAppend(int prm, cXyz * param_2, cXyz * param_3);
undefined f_op_kankyo_mng__fopKyM_Delete();
undefined f_op_kankyo_mng__fopKyM_Create();
undefined f_op_kankyo_mng__fopKyM_create(int procName, undefined4 parameter, undefined4 pPos, undefined4 pScale, undefined4 param_5);
undefined f_op_kankyo_mng__fopKyM_fastCreate();
int f_op_kankyo_mng__fopKyM_createWpillar(cXyz * pPos, float scaleXZ, float scaleY, int prm);
undefined f_op_kankyo_mng__fopKyM_createMpillar();
undefined MyPicture__drawSelf(MyPicture * this, float param_1, float param_2);
undefined MyPicture__drawSelf_1(MyPicture * this, float param_1, float param_2, float * param_3);
...
fopMsgM_prm_class * f_op_msg_mng__createAppend(fopAc_ac_c * pActor, cXyz * pPos, int * param_3, int * param_4, int param_5);
...
undefined f_op_msg_mng__fopMsgM_messageSet_1();
undefined f_op_msg_mng__fopMsgM_messageSet_2();
...
undefined f_op_msg_mng__fopMsgM_outFontSet_1();
undefined f_op_msg_mng__fopMsgM_outFontStickAnimePiece();
undefined f_op_msg_mng__fopMsgM_outFontStickAnimePiece_1();
...
undefined f_op_msg_mng__fopMsgM_outFontStickAnime_3();
undefined f_op_msg_mng__fopMsgM_outFontStickAnime2();
undefined f_op_msg_mng__fopMsgM_outFontStickAnime2_1();
undefined f_op_msg_mng__fopMsgM_outFontStickAnime_6();
undefined f_op_msg_mng__fopMsgM_outFontStickAnime_7();
undefined f_op_msg_mng__fopMsgM_outFontArrow();
undefined f_op_msg_mng__fopMsgM_outFontArrow_1();
...
undefined fopMsgM_msgDataProc_c__selectArrow_1(fopMsgM_msgDataProc_c * this, J2DPicture * param_1, float param_2, float param_3);
...
undefined fopMsgM_msgDataProc_c__getString_1(fopMsgM_msgDataProc_c * this, char * param_1, char * param_2, char * param_3, char * param_4, ulong param_5, float * param_6, float * param_7, int * param_8);
...
undefined f_op_msg_mng__fopMsgM_pane_parts_set_1();
void f_op_msg_mng__fopMsgM_setPaneData(fopMsgM_pane_class * param_1, J2DScreen * param_2);
undefined f_op_msg_mng__fopMsgM_setPaneData_1(fopMsgM_pane_class * pPane, J2DScreen * pScreen, int fourcc);
undefined f_op_msg_mng__fopMsgM_setPaneData_2(fopMsgM_pane_class * this, undefined4 pData);
undefined f_op_msg_mng__fopMsgM_setPaneData_3();
void f_op_msg_mng__fopMsgM_paneTrans(fopMsgM_pane_class * param_1, double x, double y);
...
undefined f_op_msg_mng__fopMsgM_cposMove(fopMsgM_pane_class * this);
undefined f_op_msg_mng__fopMsgM_setAlpha(fopMsgM_pane_class * param_1);
undefined f_op_msg_mng__fopMsgM_setInitAlpha();
void f_op_msg_mng__fopMsgM_setNowAlpha(fopMsgM_pane_class * this, float alpha);
undefined f_op_msg_mng__fopMsgM_setNowAlphaZero(fopMsgM_pane_class * param_1);
undefined f_op_msg_mng__fopMsgM_setAlpha_1();
undefined f_op_msg_mng__fopMsgM_setNowAlpha_2();
...
undefined f_op_msg_mng__fopMsgM_blendInit_1();
undefined f_op_msg_mng__fopMsgM_blendDraw();
undefined f_op_msg_mng__fopMsgM_blendDraw_1(undefined4 pPic, undefined4 param_2);
...
J2DTypeID J2DPicture__getTypeID(J2DPicture * this);
...
undefined J2DPicture__drawOut_1(J2DPicture * this, float param_1, float param_2, float param_3, float param_4, float param_5, float param_6);
...
int f_pc_base__fpcBs_IsDelete(base_process_class * param_1);
...
undefined f_pc_create_iter__fpcCtIt_Method(undefined4 param_1, void * param_2);
undefined f_pc_create_iter__fpcCtIt_Judge(pointer param_1, void * param_2);
undefined f_pc_create_iter__fpcCtIt_filter_JudgeInLayer(create_tag * param_1, undefined4 param_2);
undefined f_pc_create_iter__fpcCtIt_JudgeInLayer();
undefined f_pc_create_req__fpcCtRq_isCreatingByID(create_tag * param_1, undefined4 param_2);
int f_pc_create_req__fpcCtRq_IsCreatingByID(int param_1);
undefined f_pc_create_req__fpcCtRq_CreateQTo(create_request * param_1);
void f_pc_create_req__fpcCtRq_ToCreateQ(create_request * param_1);
undefined f_pc_create_req__fpcCtRq_Delete();
undefined f_pc_create_req__fpcCtRq_Cancel(create_request * param_1);
undefined f_pc_create_req__fpcCtRq_IsDoing(create_request * param_1);
...
undefined f_pc_create_tag__fpcCtTg_ToCreateQ(create_tag * param_1);
...
undefined f_pc_creator__fpcCt_Abort(base_process_class * param_1);
...
void f_pc_delete_tag__fpcDtTg_DeleteQTo(create_tag_class * param_1);
...
int f_pc_deletor__fpcDt_IsComplete(void);
undefined f_pc_deletor__fpcDt_deleteMethod();
undefined f_pc_deletor__fpcDt_Handler();
int f_pc_deletor__fpcDt_ToQueue(base_process_class * param_1);
int f_pc_deletor__fpcDt_ToDeleteQ(base_process_class * param_1);
int f_pc_deletor__fpcDt_Delete(base_process_class * param_1);
...
int f_pc_executor__fpcEx_Execute(base_process_class * param_1);
undefined4 f_pc_executor__fpcEx_ToLineQ(process_node_class * param_1);
uint f_pc_executor__fpcEx_ExecuteQTo(base_process_class * param_1);
bool f_pc_executor__fpcEx_ToExecuteQ(base_process_class * param_1);
undefined f_pc_executor__fpcEx_Handler();
undefined f_pc_layer__fpcLy_CancelQTo();
int f_pc_layer__fpcLy_ToCancelQ(layer_class * param_1, process_method_tag_class * param_2);
...
void f_pc_layer__fpcLy_QueueTo(layer_class * param_1, create_tag_class * param_2);
undefined f_pc_layer__fpcLy_IsDeletingMesg(layer_class * param_1);
undefined f_pc_layer__fpcLy_DeletingMesg(layer_class * param_1);
undefined f_pc_layer__fpcLy_DeletedMesg(layer_class * param_1);
...
undefined f_pc_layer__fpcLy_Delete(layer_class * pLayer);
undefined f_pc_layer__fpcLy_Cancel(layer_class * param_1);
void f_pc_layer__fpcLy_Create(layer_class * pLayer, void * param_2, node_list_class * param_3, int param_4);
int fpcLf_GetPriority(leafdraw_class * param_1);
undefined fpcLf_DrawMethod(void * param_1, undefined4 param_2);
undefined fpcLf_Draw(leafdraw_class * param_1);
undefined fpcLf_Execute(leafdraw_class * param_1);
undefined fpcLf_IsDelete(leafdraw_class * param_1);
undefined fpcLf_Delete(leafdraw_class * param_1);
...
undefined f_pc_layer_tag__fpcLyTg_QueueTo(layer_management_tag_class * param_1);
undefined4 f_pc_layer_tag__fpcLyTg_Move(layer_management_tag_class * param_1, uint param_2, ushort param_3, ushort param_4);
uint f_pc_layer_tag__fpcLyTg_Init(layer_management_tag_class * param_1, uint layerID, void * param_3);
undefined f_pc_line__fpcLn_Create();
undefined f_pc_load__fpcLd_Use(ushort param_1);
void f_pc_load__fpcLd_IsLoaded(short param_1);
void f_pc_load__fpcLd_Free(ushort param_1, char * param_2);
PhaseState f_pc_load__fpcLd_Load(ushort param_1);
...
int f_pc_method__fpcMtd_Delete(profile_leaf_method_class * param_1, void * param_2);
int f_pc_method__fpcMtd_Create(profile_leaf_method_class * param_1, void * param_2);
undefined f_pc_node__fpcNd_DrawMethod();
undefined f_pc_node__fpcNd_Draw(process_node_class * param_1);
undefined f_pc_node__fpcNd_Execute();
undefined f_pc_node__fpcNd_IsCreatingFromUnder(void * param_1);
undefined f_pc_node__fpcNd_IsDeleteTiming();
undefined f_pc_node__fpcNd_IsDelete(process_node_class * param_1);
...
process_priority_class * f_pc_priority__fpcPi_GetFromQueue(void);
undefined f_pc_priority__fpcPi_Delete();
bool f_pc_priority__fpcPi_IsNormal(uint param_1, ushort param_2, ushort param_3);
int f_pc_priority__fpcPi_Change(process_priority_class * param_1, uint param_2, uint param_3, uint param_4);
int f_pc_priority__fpcPi_Handler(void);
...
undefined f_pc_line_tag__fpcLnTg_QueueTo(line_tag * param_1);
...
int f_pc_method_tag__fpcMtdTg_ToMethodQ(node_list_class * param_1, create_tag_class * param_2);
void f_pc_method_tag__fpcMtdTg_MethodQTo(create_tag_class * param_1);
int f_pc_method_tag__fpcMtdTg_Init(process_method_tag_class * param_1, void * param_2, void * param_3);
undefined f_pc_pause__fpcPause_IsEnable(base_process_class * param_1, undefined1 param_2);
undefined4 f_pc_pause__fpcPause_Enable(process_node_class * pBase, byte param_2);
undefined4 f_pc_pause__fpcPause_Disable(base_process_class * pBs, byte param_2);
void f_pc_pause__fpcPause_Init(base_process_class * pBs);
...
undefined4 d_stage__dStage_playerInit(dStage_dt_c * pStag, void * pData, int count, void * param_4);
...
undefined d_stage__dStage_mapInfo_GetOceanX(stage_map_info_class * param_1);
undefined d_stage__dStage_mapInfo_GetOceanZ(stage_map_info_class * param_1);
undefined d_stage__dStage_mapInfoInit(dStage_dt_c * param_1, void * param_2);
...
undefined4 d_stage__dStage_rpatInfoInit(dStage_dt_c * pStage, void * param_2, int param_3, void * param_4);
...
void d_stage__dStage_dt_c_decode(void * pData, dStage_dt_c * pStage, dStage_dt__FuncTable * pTable, int tableCount);
...
undefined d_map__dMap_GetTopBottomFloorNo(dStage_dt_c * param_1, undefined4 param_2, undefined4 param_3);
...
int dMap_c__getCheckPointUseGrid(byte x, byte y);
void dMap_c__getFmapChkPntPrm(int i, char * param_2, char * param_3, short * param_4, short * param_5, uchar * param_6);
undefined dMap_c__setFmapChkDtPrm(dMap_c * this);
undefined dMap_c__getFmapChkPntDtPnt(int i);
...
undefined dComIfG_changeOpeningScene(scene_class * pScene, int procName);
...
undefined dComIfGs_setSelectEquip(undefined4 category, dItem_data__ItemNo item);
...
undefined cCcD_ShapeAttr__GetCoCP_1(cCcD_ShapeAttr * this);
...
undefined daObjPirateship__getShipOffsetY(short * param_1, short * param_2, float param_3);
...
void d_lib__dLib_setCirclePath(dLib_circle_path_c * pDst);
double d_lib__dLib_getWaterY(cXyz * pDst, dBgS_ObjAcch * pAcch);
void d_lib__dLib_waveRot(cXyz * pPos, float sway, dLib_wave_c * pWave);
...
void d_lib__dLib_setAnm(char * pName, mDoExt_McaMorf * pMorf, byte * param_3, byte * param_4, byte * param_5, void * param_6, void * param_7, byte param_8);
undefined d_lib__dLib_bcks_setAnm();
void d_lib__dLib_scaleAnime(float * param_1, int param_2, int param_3, int * param_4, float param_5, float param_6, float param_7);
...
undefined dSv_player_item_c__setBottleItemIn(dSv_player_item_c * this, byte param_1, byte param_2);
...
undefined dSv_player_item_c__setEquipBottleItemIn_1(dSv_player_item_c * this, uchar param_1);
undefined dSv_player_item_c__setEquipBottleItemEmpty_1(dSv_player_item_c * this);
undefined dSv_player_item_c__checkBottle(dSv_player_item_c * this, byte param_1);
...
undefined dSv_player_get_item_c__onItem(dSv_player_get_item_c * this, int param_1, byte param_2);
...
undefined dSv_player_bag_item_c__setBaitItemChange_1(dSv_player_bag_item_c * this, uchar param_1, uchar param_2);
undefined dSv_player_bag_item_c__setBaitItemEmpty(dSv_player_bag_item_c * this);
undefined dSv_player_bag_item_c__setBaitItemEmpty_1(dSv_player_bag_item_c * this, uchar param_1);
...
undefined dSv_player_bag_item_c__setReserveItemChange_1(dSv_player_bag_item_c * this, uchar param_1, uchar param_2);
undefined dSv_player_bag_item_c__setReserveItemEmpty(dSv_player_bag_item_c * this);
undefined dSv_player_bag_item_c__setReserveItemEmpty_1(dSv_player_bag_item_c * this, uchar param_1);
...
undefined dSv_player_collect_c__onCollect(dSv_player_collect_c * this, int byteOffset, byte bitIndex);
undefined dSv_player_collect_c__offCollect(dSv_player_collect_c * this, int param_1, uchar param_2);
uint dSv_player_collect_c__isCollect(dSv_player_collect_c * this, int byteOffset, byte bitIndex);
...
void dSv_memBit_c__init(dSv_memBit_c * this);
undefined dSv_memBit_c__onTbox(dSv_memBit_c * this, int param_1);
undefined dSv_memBit_c__isTbox(dSv_memBit_c * this, int i_no);
...
undefined dSv_memBit_c__isSwitch(dSv_memBit_c * this, int i_no);
...
undefined dSv_memBit_c__isItem(dSv_memBit_c * this, int i_no);
undefined dSv_memBit_c__onVisitedRoom(dSv_memBit_c * this, int param_1);
undefined dSv_memBit_c__isVisitedRoom(dSv_memBit_c * this, int i_no);
undefined dSv_memBit_c__onDungeonItem(dSv_memBit_c * this, int param_1);
undefined dSv_memBit_c__isDungeonItem(dSv_memBit_c * this, int i_no);
...
void dSv_event_c__onEventBit(dSv_event_c * this, ushort param_1);
...
undefined dSv_event_c__setEventReg(dSv_event_c * this, ushort param_1, byte param_2);
ushort dSv_event_c__getEventReg(dSv_event_c * this, ushort param_1);
...
undefined dSv_restart_c__setRestartOption_1(dSv_restart_c * this, char param_1, cXyz * pos, short rotY, char roomNo);
...
undefined dSv_info_c__isItem(dSv_info_c * this, int i_no, int i_roomNo);
undefined dSv_info_c__onActor(dSv_info_c * this, int param_1, int param_2);
undefined dSv_info_c__isActor(dSv_info_c * this, int i_id, int i_roomNo);
...
undefined ShopItems_c__createItem(ShopItems_c * this, int numItems, int param_2);
...
undefined ShopItems_c__setItemSetDataListManual(ShopItems_c * this, __shop_items_set_data * * itemSetList);
...
undefined ShopCursor_c__setPos(ShopCursor_c * this, cXyz * pos);
ShopCursor_c * d_shop__ShopCursor_create(J3DModelData * param_1, J3DAnmTevRegKey * brkData, float param_3);
...
undefined4 JntHit_c__HitBufferUpdate(JntHit_c * this, int * pDstJointIndex, cXyz * pDstHitPos, int jointIndex, csXyz * pRot, cXyz * lpPos);
undefined JntHit_c__searchJntHitPosAngleOffset(JntHit_c * this, cXyz * param_1, csXyz * param_2, cXyz * param_3, csXyz * param_4);
JntHit_c * d_jnt_hit__JntHit_create(J3DModel * param_1, __jnt_hit_data_c * jntHitData, short hitDataCount);
...
undefined daObj__make_land_effect(fopAc_ac_c * param_1, dBgS_GndChk * param_2, float param_3);
...
undefined daObj___unnamed_d_a_obj_cpp___posMoveF_resist_acc(cXyz * pDst, fopAc_ac_c * pActor, cXyz * pStreamSpd, float param_4, float param_5);
undefined daObj___unnamed_d_a_obj_cpp___posMoveF_grade_acc(cXyz * pDst, fopAc_ac_c * pActor, cXyz * pNorm, float friction, float noGradeCos, cXyz * pAccel0, cXyz * pAccel1);
void daObj__posMoveF_grade(fopAc_ac_c * pActor, cXyz * pAddVel, cXyz * pStreamSpd, float param_4, float param_5, cXyz * pNorm, float friction, float noGradeCos, cXyz * pAddAccel);
...
undefined daObj__HitEff_hibana_1(fopAc_ac_c * param_1, dCcD_Cyl * param_2);
...
int daBomb_c__prm_get_state(daBomb_c * this);
...
undefined dDemo_actor_c__setActor(dDemo_actor_c * this, fopAc_ac_c * pActor);
...
undefined4 d_demo__dDemo_setDemoData(fopAc_ac_c * pActor, ushort flags, mDoExt_McaMorf * pMorf, char * pArcName, undefined4 param_5, undefined4 param_6, ulong param_7, char param_8);
...
undefined dDemo_actor_c__JSGSetScaling(dDemo_actor_c * this, cXyz * param_1);
undefined dDemo_actor_c__JSGSetRotation(dDemo_actor_c * this, cXyz * param_1);
...
camera_class * d_demo__getView(void);
...
undefined dDemo_camera_c__JSGGetViewPosition(dDemo_camera_c * this, cXyz * param_1);
undefined dDemo_camera_c__JSGSetViewPosition(dDemo_camera_c * this, cXyz * param_1);
undefined dDemo_camera_c__JSGGetViewUpVector(dDemo_camera_c * this, cXyz * param_1);
undefined dDemo_camera_c__JSGSetViewUpVector(dDemo_camera_c * this, cXyz * param_1);
undefined dDemo_camera_c__JSGGetViewTargetPosition(dDemo_camera_c * this, cXyz * param_1);
undefined dDemo_camera_c__JSGSetViewTargetPosition(dDemo_camera_c * this, cXyz * param_1);
...
undefined dDemo_light_c__JSGSetPosition(dDemo_light_c * this, cXyz * param_1);
...
undefined dDemo_light_c__JSGSetAngleAttenuation(dDemo_light_c * this, float param_1, _GXSpotFn param_2);
...
undefined dDemo_object_c__appendActor(dDemo_object_c * this, fopAc_ac_c * pActor);
...
undefined dDemo_system_c__JSGFindObject(dDemo_system_c * this, char * pName, TEObject objectType);
...
undefined dDemo_manager_c__create(dDemo_manager_c * this, uchar * param_1, cXyz * pPos, float offsAngY);
...
undefined dDemo_actor_c__JSGGetTranslation(dDemo_actor_c * this, cXyz * param_1);
...
void d_resorce__setToonTex(J3DModelData * pModel);
undefined d_resorce__setToonTex_1(J3DMaterialTable * pMat);
...
undefined4 dRes_control_c__deleteRes(char * pName, dRes_info_c * pResInfoList, int count);
dRes_info_c * dRes_control_c__getResInfo(char * pArcName, dRes_info_c * pResInfoList, int count);
...
undefined dMat_ice_c__updateDL_1(dMat_ice_c * this, mDoExt_McaMorf * param_1, char param_2, mDoExt_invisibleModel * param_3);
undefined dMat_ice_c__entryDL(dMat_ice_c * this, J3DModel * param_1, char param_2, mDoExt_invisibleModel * param_3);
undefined dMat_ice_c__entryDL_1(dMat_ice_c * this, mDoExt_McaMorf * param_1, char param_2, mDoExt_invisibleModel * param_3);
...
undefined dEvt_control_c__commonCheck(dEvt_control_c * this, dEvt_order_c * pOrder, dEvt__ActorCondition checkOrderFlag, dEvt__ActorCommand setActorMode);
...
undefined dEvt_control_c__photoCheck_1(dEvt_control_c * this);
dEvt__MoveApprovalFlag dEvt_control_c__moveApproval(dEvt_control_c * this, fopAc_ac_c * pActor);
...
int dEvent_manager_c__startCheckOld(dEvent_manager_c * this, char * param_1);
bool dEvent_manager_c__endCheck(dEvent_manager_c * this, short param_1);
bool dEvent_manager_c__endCheckOld(dEvent_manager_c * this, char * param_1);
...
void dMagma_ball_c__draw(dMagma_ballPath_c * this);
undefined4 dMagma_ball_c__rangeCheck(dMagma_ballPath_c * this, cXyz * pPos, float * param_3);
undefined dMagma_ballPath_c__calc(dMagma_ballPath_c * this, float param_1, uchar pathIndex, int roomNo);
undefined dMagma_ballPath_c__update(dMagma_ballPath_c * this);
undefined dMagma_ballPath_c__setup(dMagma_ballPath_c * this, float yOffset, uchar pathIndex, int roomNo);
undefined dMagma_floor_c__draw(dMagma_floor_c * this);
undefined dMagma_floor_c__calc(dMagma_floor_c * this, int roomNo);
...
int dMagma_floor_c__remove(dMagma_floor_c * this);
undefined dMagma_room_c__newFloor(dMagma_room_c * this, dMagma_floor_c * pRoom);
...
undefined dMagma_packet_c__checkYpos(dMagma_packet_c * this, cXyz * pPos);
...
void dPa_smokeEcallBack__dPa_smokeEcallBack_2(dPa_smokeEcallBack * this, uchar param_1, uchar param_2, uchar param_3, uchar param_4);
void dPa_smokeEcallBack__dPa_smokeEcallBack_3(dPa_smokeEcallBack * this, _GXColor * param_1, dKy_tevstr_c * param_2, uchar param_3);
...
undefined d_particle__dPa_setWindPower(JPABaseParticle * pPtcl);
...
undefined dPa_simpleEcallBack__executeAfter(dPa_simpleEcallBack * this, JPABaseEmitter * pEmtr);
void dPa_windPcallBack__dPa_windPcallBack_destructor(dPa_windPcallBack * this);
undefined dPa_simpleEcallBack__draw(dPa_simpleEcallBack * this, JPABaseEmitter * pPtcl);
...
int dPa_simpleEcallBack__set(dPa_simpleEcallBack * this, cXyz * pos, uchar alpha, _GXColor * pPrmColor, _GXColor * pEnvColor, int bAffectedByWind);
...
undefined dPa_control_c__getRM_ID(ushort userID);
...
int dPa_control_c__readScene(dPa_control_c * this, uchar i_no, mDoDvdThd_toMainRam_c * * pDstToMainRam);
...
JPABaseEmitter * dPa_control_c__set(dPa_control_c * this, byte groupID, ushort userID, cXyz * pPos, csXyz * pRot, cXyz * pScale, byte alpha, dPa_levelEcallBack * pCallBack, char setupInfo, _GXColor * pPrmColor, _GXColor * pEnvColor, cXyz * pPublicScale2D);
...
undefined dPa_control_c__setSimpleLand_1(dPa_control_c * this, cBgS_PolyInfo * param_1, cXyz * param_2, csXyz * param_3, float param_4, float param_5, float param_6, dKy_tevstr_c * param_7, int * param_8, int param_9);
...
int dPa_control_c__setSimple(dPa_control_c * this, ushort param_1, cXyz * param_2, uchar param_3, _GXColor * param_4, _GXColor * param_5, int param_6);
dPa_simpleEcallBack * dPa_control_c__getSimple(dPa_control_c * this, ushort param_1);
...
undefined dPa_waveEcallBack__executeAfter(dPa_waveEcallBack * this, JPABaseEmitter * pEmitter);
void dPa_waveEcallBack__draw(dPa_waveEcallBack * this, JPABaseEmitter * pEmtr);
...
undefined dPa_bombSmokeEcallBack__execute(dPa_bombSmokeEcallBack * this, JPABaseEmitter * pEmtr);
void dPa_trackEcallBack__getMaxWaterY(dPa_trackEcallBack * this, cXyz * pVec);
...
undefined dPa_trackEcallBack__draw(dPa_trackEcallBack * this, JPABaseEmitter * pEmitter);
...
undefined d_path__dPath_GetPnt(dPath * pPath, undefined4 idx);
...
undefined dDlst_shadowPoly_c__set_1(dDlst_shadowPoly_c * this, cXyz * param_1, cXyz * param_2, cXyz * param_3);
...
int dDlst_shadowReal_c__init(dDlst_shadowReal_c * this);
...
pointer d_drawlist__psdRealCallBack(void);
...
uint d_drawlist__setShadowRealMtx(MTX34 * pDstView, MTX44 * pDstRenderProj, MTX34 * pDstReceiverProj, cXyz * pLightPos, cXyz * pPos, float param_6, float param_7, dDlst_shadowPoly_c * pPoly, float param_9);
undefined dDlst_shadowReal_c__set(dDlst_shadowReal_c * this, ulong param_1, char param_2, J3DModel * pModel, cXyz * param_4, float param_5, float param_6, dKy_tevstr_c * param_7);
undefined dDlst_shadowReal_c__set2(dDlst_shadowReal_c * this, ulong id, char param_2, J3DModel * pModel, cXyz * pPos, float param_5, float param_6, dKy_tevstr_c * pTevStr);
undefined dDlst_shadowReal_c__add(dDlst_shadowReal_c * this, J3DModel * pModel);
undefined dDlst_shadowSimple_c__draw(dDlst_shadowSimple_c * this);
undefined dDlst_shadowSimple_c__set(dDlst_shadowSimple_c * this, cXyz * pPos, float param_2, float param_3, cXyz * pFloorNrm, short rotY, float param_6, _GXTexObj * pTexObj);
...
undefined dDlst_shadowControl_c__imageDraw(dDlst_shadowControl_c * this, MTX34 * param_1);
...
undefined dDlst_shadowControl_c__setReal2(dDlst_shadowControl_c * this, ulong id, char param_2, J3DModel * pModel, cXyz * pPos, float param_5, float param_6, dKy_tevstr_c * pTevStr);
undefined dDlst_shadowControl_c__addReal(dDlst_shadowControl_c * this, ulong param_1, J3DModel * param_2);
undefined dDlst_shadowControl_c__setSimple(dDlst_shadowControl_c * this, cXyz * pPos, float param_2, float param_3, cXyz * pFloorNrm, short rotY, float param_6, _GXTexObj * pTexObj);
void dDlst_shadowControl_c__setSimpleTex(void * param_1);
undefined dDlst_mirrorPacket__draw(dDlst_mirrorPacket * this);
int dDlst_mirrorPacket__init(dDlst_mirrorPacket * this, ResTIMG * ctx);
undefined d_drawlist__mirrorPolygonCheck();
undefined dDlst_mirrorPacket__update(dDlst_mirrorPacket * this, MTX34 * param_1, uchar param_2, float param_3);
...
undefined dDlst_list_c__entryZSortXluDrawList(dDlst_list_c * this, J3DDrawBuffer * pBuffer, J3DPacket * pPacket, cXyz * pPos);
void dDlst_list_c__set(dDlst_list_c * this, dDlst_base_c * * * pLst, dDlst_base_c * * * * pEnd, dDlst_base_c * pPacket);
void dDlst_list_c__draw(dDlst_list_c * this, dDlst_base_c * * pBegin, dDlst_base_c * * pEnd);
undefined dDlst_list_c__wipeIn(float param_1, _GXColor * param_2);
void dDlst_list_c__wipeIn_1(float param_1);
undefined dDlst_list_c__calcWipe(dDlst_list_c * this);
void d_drawlist__dDlst_texSpecmapST(cXyz * pPos, dKy_tevstr_c * pTevStr, J3DModelData * pData, float scale);
...
void d_kankyo_wether__dKyw_squal_set(cXyz * pPos, uint rx, uint ry, float radius, float param_5, float strength, float param_7, float param_8);
...
bool d_kankyo_rain__forward_overhead_bg_chk(cXyz * param_1, float param_2);
...
void dBgS_ObjGndChk_All__dBgS_ObjGndChk_All_destructor_1(dBgS_ObjGndChk_All * this);
void dBgS_ObjGndChk_All__dBgS_ObjGndChk_All_destructor_2(dBgS_ObjGndChk_All * this);
void dBgS_ObjGndChk_All__dBgS_ObjGndChk_All_destructor_3(dBgS_ObjGndChk_All * this);
void dBgS_RoofChk__dBgS_RoofChk_destructor_1(dBgS_RoofChk * this);
void dBgS_RoofChk__dBgS_RoofChk_destructor_2(dBgS_RoofChk * this);
void dBgS_RoofChk__dBgS_RoofChk_destructor_3(dBgS_RoofChk * this);
...
undefined dDetect_c__set_quake(dDetect_c * this, cXyz * pPos);
undefined dDetect_c__chk_quake_area(dDetect_c * this, cXyz * pPos);
dDetect_c * dDetect_c__search_tag_light(fopAc_ac_c * pActor, void * param_2);
undefined dDetect_c__chk_light(dDetect_c * this, cXyz * pPos);
undefined dDetect_c__chk_attention(dDetect_c * this, cXyz * pDst);
undefined daObj__PrmAbstract_1(daObj * this, fopAc_ac_c * param_1, Prm_e param_2, Prm_e param_3);
...
undefined dVibration_c__StartQuake_1(dVibration_c * this, uchar * param_1, int param_2, int param_3, cXyz * param_4);
...
void dAttention_c__dAttention_c(dAttention_c * this, fopAc_ac_c * pActor, ulong playerNo);
...
dAttList_c * dAttention_c__GetLockonList(dAttention_c * this, long idx);
...
undefined dAttention_c__chkAttMask(dAttention_c * this, ulong type, ulong mask);
undefined d_attention__check_event_condition(undefined4 locType, dEvt__ActorCondition behaviorFlags);
...
float dAttention_c__calcWeight(dAttention_c * this, char mode, fopAc_ac_c * pActor, float distance, short angle1, short angle2, int * pDstLocType);
undefined dAttention_c__setLList(dAttention_c * this, fopAc_ac_c * pActor, float weight, float distance, ulong type);
undefined dAttention_c__setAList(dAttention_c * this, fopAc_ac_c * pActor, float weight, float distance, ulong type);
undefined dAttention_c__initList(dAttention_c * this, ulong flagMask);
...
undefined dAttention_c__nextAttention(dAttention_c * this, ulong interactMask);
undefined dAttention_c__freeAttention(dAttention_c * this);
int dAttention_c__chaseAttention(dAttention_c * this);
undefined dAttention_c__EnemyDistance(dAttention_c * this, fopAc_ac_c * pActor);
undefined d_attention__sound_attention(undefined4 pActor, undefined4 pAttention);
...
undefined dAttention_c__Run(dAttention_c * this, ulong interactMask);
...
fopAc_ac_c * dAttention_c__LockonTarget(dAttention_c * this, long idx);
...
int dAttention_c__LockonTruth(dAttention_c * this);
...
undefined dAttHint_c__request(dAttHint_c * this, fopAc_ac_c * pActor, int priority);
...
fopAc_ac_c * dAttLook_c__convPId(dAttLook_c * this, uint param_1);
...
undefined dBgS__LineCrossNonMoveBG(dBgS * this, cBgS_LinChk * pChk);
undefined dBgS__WallCorrect(dBgS * this, dBgS_Acch * pAcch);
...
undefined dBgS__MoveBgCrrPos(dBgS * this, cBgS_PolyInfo * pPolyInf, bool param_2, cXyz * pDstPos, csXyz * pRot, csXyz * pCollisionRot);
...
undefined dBgS_Acch__Set(dBgS_Acch * this, cXyz * pPos, cXyz * pOldPos, fopAc_ac_c * pActor, int cirCount, dBgS_AcchCir * pCir, cXyz * param_6, csXyz * param_7, csXyz * param_8);
undefined dBgS_Acch__GroundCheckInit(dBgS_Acch * this, dBgS * param_1);
undefined dBgS_Acch__GroundCheck(dBgS_Acch * this, dBgS * pBg);
...
undefined dBgS_Acch__CrrPos(dBgS_Acch * this, dBgS * pBg);
...
undefined dBgS_Acch__GetOnePolyInfo(dBgS_Acch * this, cBgS_PolyInfo * pDst);
undefined dBgS_Acch__GetWallAddY(dBgS_Acch * this, cXyz * param_1, int param_2);
...
void dBgS_Acch__dBgS_Acch_destructor_1(dBgS_Acch * this);
void dBgS_Acch__dBgS_Acch_destructor_2(dBgS_Acch * this);
void dBgS_ObjAcch__dBgS_ObjAcch_destructor_1(dBgS_ObjAcch * this);
void dBgS_ObjAcch__dBgS_ObjAcch_destructor_2(dBgS_ObjAcch * this);
...
void dBgS_ObjGndChk_Wtr__dBgS_ObjGndChk_Wtr_destructor_1(dBgS_ObjGndChk_Wtr * this);
void dBgS_ObjGndChk_Wtr__dBgS_ObjGndChk_Wtr_destructor_2(dBgS_ObjGndChk_Wtr * this);
void dBgS_ObjGndChk_Wtr__dBgS_ObjGndChk_Wtr_destructor_3(dBgS_ObjGndChk_Wtr * this);
undefined dBgS_LinChk__Set(dBgS_LinChk * this, cXyz * param_1, cXyz * param_2, fopAc_ac_c * pActor);
...
undefined dBgW__positionWallCorrect(dBgW * this, dBgS_Acch * pAcch, float param_2, cM3dGPla * pPla, cXyz * pUpperPos, float param_5);
undefined dBgW__RwgWallCorrect(dBgW * this, dBgS_Acch * pAcch, ushort rwg);
undefined dBgW__WallCorrectRp(dBgW * this, dBgS_Acch * pAcch, int node);
...
undefined dBgW__CrrPos(dBgW * this, cBgS_PolyInfo * pPolyInf, void * param_2, bool param_3, cXyz * param_4, csXyz * param_5, csXyz * param_6);
undefined dBgW__TransPos(dBgW * this, cBgS_PolyInfo * pPolyInf, void * param_2, bool param_3, cXyz * param_4, csXyz * param_5, csXyz * param_6);
...
undefined dBgW__ChkGrpThrough(dBgW * this, int param_1, cBgS_GrpPassChk * grpPassChk, int depth);
...
fopAc_ac_c * dCcD_GAtTgCoCommonBase__GetAc(dCcD_GAtTgCoCommonBase * this);
...
undefined dCcD_GObjAt__Set(dCcD_GObjAt * this, dCcD_SrcGObjAt * pSrc);
undefined dCcD_GObjTg__Set(dCcD_GObjTg * this, dCcD_SrcGObjTg * pSrc);
...
dCcD_GObjInf * d_cc_d__dCcD_GetGObjInf(cCcD_Obj * pObj);
...
undefined cCcD_Obj__GetShapeAttr_1(cCcD_Obj * this);
...
undefined cCcD_GObjInf__GetGObjInf_1(cCcD_GObjInf * this);
undefined cCcD_Obj__GetGObjInf_1(cCcD_Obj * this);
...
void dCcD_Stts__dCcD_Stts_destructor_1(dCcD_Stts * this);
...
int dCcS__ChkShield(dCcS * this, cCcD_Obj * pAt, cCcD_Obj * pTg, dCcD_GObjInf * pAtInf, dCcD_GObjInf * pTgInf);
undefined dCcS__CalcTgPlusDmg(dCcS * this, cCcD_Obj * pAt, cCcD_Obj * pTg, cCcD_Stts * pAtStts, cCcD_Stts * pTgStts);
undefined4 dCcS__ChkAtTgHitAfterCross(dCcS * this, bool bAt, bool bTg, dCcD_GObjInf * pAtInf, dCcD_GObjInf * pTgInf, dCcD_Stts * pAtStts, dCcD_Stts * pTgStts, dCcD_GStts * pAtGStts, dCcD_GStts * pTgGStts);
undefined dCcS__SetCoGObjInf(dCcS * this, bool bCo1, bool bCo2, dCcD_GObjInf * pCo1, dCcD_GObjInf * pCo2, dCcD_Stts * pStts1, dCcD_Stts * pStts2, dCcD_GStts * pGStts1, dCcD_GStts * pGStts2);
undefined dCcS__GetRank(dCcS * this, uchar param_1);
undefined dCcS__SetPosCorrect(dCcS * this, cCcD_Obj * pCo1, cXyz * param_2, cCcD_Obj * pCo2, cXyz * param_4, float param_5);
undefined dCcS__CalcParticleAngle(dCcS * this, dCcD_GObjInf * param_1, cCcD_Stts * param_2, cCcD_Stts * param_3, csXyz * param_4);
undefined dCcS__ProcAtTgHitmark(dCcS * this, bool bAt, bool bTg, cCcD_Obj * pAt, cCcD_Obj * pTg, dCcD_GObjInf * pAtInf, dCcD_GObjInf * pTgInf, cCcD_Stts * pAtStts, cCcD_Stts * pTgStts, dCcD_GStts * pAtGStts, dCcD_GStts * pTgGStts, cXyz * pCrossPos);
void dCcS__SetAtTgGObjInf(dCcS * this, bool bAt, bool bTg, cCcD_Obj * pAt, cCcD_Obj * pTg, dCcD_GObjInf * pAtInf, dCcD_GObjInf * pTgInf, dCcD_Stts * pAtStts, dCcD_Stts * pTgStts, dCcD_GStts * pAtGStts, dCcD_GStts * pTgGStts, cXyz * pCrossPos);
undefined dCcS__ChkCamera(dCcS * this, cXyz * pP0, cXyz * pP1, float r, fopAc_ac_c * pCoActor, fopAc_ac_c * pFilterActor);
...
undefined dCcS__ChkNoHitGCo(dCcS * this, cCcD_Obj * pObj1, cCcD_Obj * pObj2);
...
void d_cc_uty__at_power_check(CcAtInfo * pDst);
fopAc_ac_c * d_cc_uty__cc_at_check(fopAc_ac_c * pActor, CcAtInfo * pDst);
uint daObj__PrmAbstract_2(fopAc_ac_c * param_1, Prm_e param_2, Prm_e param_3);
undefined dCamMath__rationalBezierRatio(float param_1, float param_2);
float dCamMath__customRBRatio(float param_1, float param_2);
...
void dCamMath__xyzRotateY(cXyz * param_1, cSAngle param_2);
undefined dCamMath__xyzHorizontalDistance(cXyz * param_1, cXyz * param_2);
...
int dCamParam_c__SearchStyle(dCamParam_c * this, ulong magic);
undefined dCamParam_c__ratiof(dCamParam_c * this, float t, float upper, float lower, float base);
undefined dCamParam_c__DefaultRadius(dCamParam_c * this, float * pR);
undefined dCamParam_c__RadiusRatio(dCamParam_c * this, float r);
float dCamParam_c__CenterHeight(dCamParam_c * this, float param_1);
...
undefined dCamera_c__getEvIntData_1(dCamera_c * this, int * param_1, char * param_2, int param_3);
...
undefined dCamera_c__getEvStringPntData_1(dCamera_c * this, char * param_1, char * param_2);
fopAc_ac_c * dCamera_c__getEvActor(dCamera_c * this, char * param_1);
undefined dCamera_c__getEvActor_1(dCamera_c * this, char * param_1, char * param_2);
...
void cXyz__cXyz_2(cXyz * this, cXyz * param_1);
...
undefined dWood__Packet_c__put_unit(Packet_c * this, cXyz * pPos, int room_no);
...
int dSeaFightGame_info_c__init(dSeaFightGame_info_c * this, int bulletNum, int scenario);
...
undefined d2DBSplinePath__Calc_1(d2DBSplinePath * this, float * param_1);
...
int dSalvage_control_c__init(dSalvage_control_c * this);
...
cXyz * dSalvage_control_c__getPos(cXyz * __return_storage_ptr__, dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getPosP(dSalvage_control_c * this, int param_1);
cXyz * dSalvage_control_c__getScale(cXyz * __return_storage_ptr__, dSalvage_control_c * this, int param_1);
undefined dSalvage_control_c__getR(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getH(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getRoomNo(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getItemNo(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getSwitchNo(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getSaveNo(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getType(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getKind(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getDistance(dSalvage_control_c * this, int i);
undefined dSalvage_control_c__getAlphaPtr(dSalvage_control_c * this, int i);
...
undefined dSalvage_control_c__setPos(dSalvage_control_c * this, int i, cXyz * pPos);
undefined dSalvage_control_c__setFlag(dSalvage_control_c * this, int i, uchar v);
undefined dSalvage_control_c__clrFlag(dSalvage_control_c * this, int i, uchar param_2);
undefined dSalvage_control_c__setNowAlpha(dSalvage_control_c * this, int i, uchar param_2);
undefined dSalvage_control_c__setDrawMode(dSalvage_control_c * this, int i, int param_2);
int d_snap__dSnap_PhotoIndex2TableIndex(int param_1);
undefined d_snap__dSnap_GetFigRoomId(undefined4 figure);
...
void d_snap__dSnap_RegistFig_1(byte param_1, fopAc_ac_c * param_2, cXyz * param_3, short param_4, float param_5, float param_6, float param_7);
...
undefined J3DTevBlock__setTevColor_1(J3DTevBlock * this, ulong param_1, J3DGXColorS10 * param_2);
...
undefined d_a_agb__daAgb_Create(daAgb_c * pthis);
...
void dBgS_LinkLinChk__dBgS_LinkLinChk_destructor_1(dBgS_LinkLinChk * this);
void dBgS_LinkLinChk__dBgS_LinkLinChk_destructor_2(dBgS_LinkLinChk * this);
void dBgS_LinkLinChk__dBgS_LinkLinChk_destructor_3(dBgS_LinkLinChk * this);
void dBgS_LinkAcch__dBgS_LinkAcch_destructor_1(dBgS_LinkAcch * this);
void dBgS_LinkAcch__dBgS_LinkAcch_destructor_2(dBgS_LinkAcch * this);
void dBgS_LinkCrrPos__dBgS_LinkCrrPos_destructor_1(dBgS_LinkCrrPos * this);
void dBgS_LinkCrrPos__dBgS_LinkCrrPos_destructor_2(dBgS_LinkCrrPos * this);
void dBgS_LinkCrrPos__dBgS_LinkCrrPos_destructor_3(dBgS_LinkCrrPos * this);
void dBgS_CrrPos__dBgS_CrrPos_destructor_1(dBgS_CrrPos * this);
void dBgS_CrrPos__dBgS_CrrPos_destructor_2(dBgS_CrrPos * this);
void dBgS_CrrPos__dBgS_CrrPos_destructor_3(dBgS_CrrPos * this);
...
undefined cCcD_SphAttr__GetCoCP_1(cCcD_SphAttr * this);
undefined cCcD_SphAttr__CrossAtTg(cCcD_SphAttr * this, cCcD_AabAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossAtTg_1(cCcD_SphAttr * this, cCcD_PntAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossAtTg_2(cCcD_SphAttr * this, cCcD_ShapeAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossCo(cCcD_SphAttr * this, cCcD_AabAttr * param_1, float * param_2);
undefined cCcD_SphAttr__CrossCo_1(cCcD_SphAttr * this, cCcD_TriAttr * param_1, float * param_2);
undefined cCcD_SphAttr__CrossCo_2(cCcD_SphAttr * this, cCcD_PntAttr * param_1, float * param_2);
undefined cCcD_SphAttr__CrossCo_3(cCcD_SphAttr * this, cCcD_ShapeAttr * param_1, float * param_2);
...
undefined cCcD_CpsAttr__CrossAtTg_1(cCcD_CpsAttr * this, cCcD_PntAttr * param_1, cXyz * param_2);
undefined cCcD_CpsAttr__CrossAtTg_2(cCcD_CpsAttr * this, cCcD_ShapeAttr * param_1, cXyz * param_2);
undefined cCcD_CpsAttr__CrossCo(cCcD_CpsAttr * this, cCcD_AabAttr * param_1, float * param_2);
undefined cCcD_CpsAttr__CrossCo_1(cCcD_CpsAttr * this, cCcD_TriAttr * param_1, float * param_2);
undefined cCcD_CpsAttr__CrossCo_2(cCcD_CpsAttr * this, cCcD_PntAttr * param_1, float * param_2);
undefined cCcD_CpsAttr__CrossCo_3(cCcD_CpsAttr * this, cCcD_ShapeAttr * param_1, float * param_2);
undefined d_a_arrow__cLib_calcTimer();
void dBgS_ArrowLinChk__dBgS_ArrowLinChk_destructor_1(dBgS_ArrowLinChk * this);
void dBgS_ArrowLinChk__dBgS_ArrowLinChk_destructor_2(dBgS_ArrowLinChk * this);
void dBgS_ArrowLinChk__dBgS_ArrowLinChk_destructor_3(dBgS_ArrowLinChk * this);
void dCcD_Cps__dCcD_Cps_destructor_1(dCcD_Cps * this);
void dCcD_Cps__dCcD_Cps_destructor_2(dCcD_Cps * this);
void dCcD_Sph__dCcD_Sph_destructor_1(dCcD_Sph * this);
void dCcD_Sph__dCcD_Sph_destructor_2(dCcD_Sph * this);
...
undefined _unnamed_d_a_bomb_cpp___chk_attrState(daBomb_c * this, AttrSt_e b);
undefined daBomb_fuseSmokeEcallBack__executeAfter(daBomb_fuseSmokeEcallBack * this, JPABaseEmitter * param_1);
undefined daBomb_fuseSparksEcallBack__execute(daBomb_fuseSparksEcallBack * this, JPABaseEmitter * pEmitter);
...
undefined daBomb_c__makeFireEffect(daBomb_c * this, cXyz * pPos, csXyz * pRot);
...
void dBgS_BombAcch__dBgS_BombAcch_destructor_1(dBgS_BombAcch * this);
void dBgS_BombAcch__dBgS_BombAcch_destructor_2(dBgS_BombAcch * this);
...
undefined daObj__PrmAbstract_3(daObj * this, fopAc_ac_c * param_1, Prm_e param_2, Prm_e param_3);
...
void dBgS_BoomerangLinChk__dBgS_BoomerangLinChk_destructor_1(dBgS_BoomerangLinChk * this);
void dBgS_BoomerangLinChk__dBgS_BoomerangLinChk_destructor_2(dBgS_BoomerangLinChk * this);
void dBgS_BoomerangLinChk__dBgS_BoomerangLinChk_destructor_3(dBgS_BoomerangLinChk * this);
...
undefined cCcD_CylAttr__GetCoCP_1(cCcD_CylAttr * this);
undefined cCcD_CylAttr__CrossAtTg_1(cCcD_CylAttr * this, cCcD_AabAttr * param_1, cXyz * param_2);
undefined cCcD_CylAttr__CrossAtTg_2(cCcD_CylAttr * this, cCcD_PntAttr * param_1, cXyz * param_2);
undefined cCcD_CylAttr__CrossCo_1(cCcD_CylAttr * this, cCcD_AabAttr * param_1, float * param_2);
undefined cCcD_CylAttr__CrossCo_2(cCcD_CylAttr * this, cCcD_TriAttr * param_1, float * param_2);
undefined cCcD_CylAttr__CrossCo_3(cCcD_CylAttr * this, cCcD_PntAttr * param_1, float * param_2);
...
void dCcD_Cyl__dCcD_Cyl_destructor_1(dCcD_Cyl * this);
void dCcD_Cyl__dCcD_Cyl_destructor_2(dCcD_Cyl * this);
...
undefined d_a_esa__daEsa_Draw(fopAc_daEsa * param_1);
undefined d_a_esa__bg_check(fopAc_daEsa * param_1);
undefined d_a_esa__esa_1_move();
undefined d_a_esa__daEsa_Execute(fopAc_daEsa * param_1);
undefined d_a_esa__daEsa_IsDelete();
undefined d_a_esa__daEsa_Delete(fopAc_daEsa * param_1);
undefined d_a_esa__daEsa_CreateHeap(fopAc_daEsa * param_1);
undefined d_a_esa__daEsa_Create(fopAc_daEsa * param_1);
cXyz * daPy_py_c__getLeftHandPos(cXyz * __return_storage_ptr__, daPy_py_c * this);
...
char * d_a_himo2__dComIfGp_getStartStageName(void);
...
void dBgS_RopeLinChk__dBgS_RopeLinChk_destructor_1(dBgS_RopeLinChk * this);
void dBgS_RopeLinChk__dBgS_RopeLinChk_destructor_2(dBgS_RopeLinChk * this);
void dBgS_RopeLinChk__dBgS_RopeLinChk_destructor_3(dBgS_RopeLinChk * this);
...
undefined d_a_item__daItem_Create(undefined4 this);
...
undefined d_a_npc_fa1__cLib_getRndValue_1();
...
void dBgS_ObjLinChk__dBgS_ObjLinChk_destructor_1(dBgS_ObjLinChk * this);
void dBgS_ObjLinChk__dBgS_ObjLinChk_destructor_2(dBgS_ObjLinChk * this);
void dBgS_ObjLinChk__dBgS_ObjLinChk_destructor_3(dBgS_ObjLinChk * this);
void daPy_py_c__changePlayer(daPy_py_c * this, fopAc_ac_c * pPlayer);
...
undefined daPy_mtxFollowEcallBack_c__makeEmitter(daPy_mtxFollowEcallBack_c * this, ushort param_1, MTX34 * param_2, cXyz * param_3, cXyz * param_4);
...
undefined daPy_matAnm_c__calc(daPy_matAnm_c * this, J3DMaterial * pMat);
...
undefined d_a_player_main__daPy_auraCallback(J3DNode * param_1, undefined4 param_2);
...
undefined daPy_lk_c__setBlurPosResource(daPy_lk_c * this, ushort fileIdx);
undefined daPy_lk_c__getItemAnimeResource(daPy_lk_c * this, ushort param_1);
undefined daPy_lk_c__getAnimeResource(daPy_lk_c * this, daPy_anmHeap_c * pAnmHeap, ushort param_2, ulong param_3);
undefined daPy_lk_c__getUnderUpperAnime(daPy_lk_c * this, daPy_anmIndex_c * pIdx, J3DAnmTransform * * param_2, J3DAnmTransform * * param_3, int param_4, ulong param_5);
undefined daPy_lk_c__setTextureAnimeResource(daPy_lk_c * this, J3DAnmTexPattern * param_1, int param_2);
J3DAnmTexPattern * daPy_lk_c__loadTextureAnimeResource(daPy_lk_c * this, ulong fileIdx, int bIsFromDemo);
...
undefined daPy_lk_c__setTextureAnime(daPy_lk_c * this, ushort idx, int param_2);
...
undefined daPy_lk_c__setTextureScrollResource(daPy_lk_c * this, J3DAnmTextureSRTKey * pData, int param_2);
J3DAnmTextureSRTKey * daPy_lk_c__loadTextureScrollResource(daPy_lk_c * this, ulong param_1, int param_2);
...
undefined daPy_lk_c__hideHatAndBackle(daPy_lk_c * this, J3DMaterial * pMaterial);
...
void daPy_lk_c__setBlendMoveAnime(daPy_lk_c * this, float param_1);
...
undefined daPy_lk_c__commonProcInit(daPy_lk_c * this, daPy_PROC proc);
...
undefined daPy_lk_c__setAtParam(daPy_lk_c * this, cCcD_Obj__DamageTypes damageType, int damageAmount, dCcG_At_Spl spl, byte seType, byte hitmarkType, daPy_py_c__PlayerAttackState attackState, float cpsRadius);
...
J3DAnmTextureSRTKey * daPy_lk_c__entryBtk(daPy_lk_c * this, J3DModelData * param_1, int param_2);
J3DAnmTevRegKey * daPy_lk_c__entryBrk(daPy_lk_c * this, J3DModelData * param_1, int brkFileIndex);
...
undefined daPy_lk_c__setSingleMoveAnime(daPy_lk_c * this, daPy_ANM anm, float param_2, float param_3, short param_4, float param_5);
...
undefined daPy_lk_c__setHandModel(daPy_lk_c * this, daPy_ANM anm);
daPy_anmIndex_c * daPy_lk_c__getAnmData(daPy_lk_c * this, daPy_ANM param_1);
...
undefined daPy_lk_c__setPlayerPosAndAngle_1(daPy_lk_c * this, cXyz * param_1, csXyz * param_2);
undefined daPy_lk_c__setPlayerPosAndAngle_2(daPy_lk_c * this, float * param_1);
...
undefined daPy_swBlur_c__initSwBlur(daPy_swBlur_c * this, MTX34 * param_1, int param_2, float param_3, daPy_swBlur_c__BlurColorType blurColorType);
undefined daPy_swBlur_c__copySwBlur(daPy_swBlur_c * this, MTX34 * param_1, int param_2);
...
undefined daPy_lk_c__checkNotCrawlStand_1(daPy_lk_c * this, cXyz * param_1, cXyz * param_2);
...
void dBgS_LinkGndChk__dBgS_LinkGndChk_destructor_1(dBgS_LinkGndChk * this);
void dBgS_LinkGndChk__dBgS_LinkGndChk_destructor_2(dBgS_LinkGndChk * this);
void dBgS_LinkGndChk__dBgS_LinkGndChk_destructor_3(dBgS_LinkGndChk * this);
void dBgS_LinkRoofChk__dBgS_LinkRoofChk_destructor_1(dBgS_LinkRoofChk * this);
void dBgS_LinkRoofChk__dBgS_LinkRoofChk_destructor_2(dBgS_LinkRoofChk * this);
void dBgS_LinkRoofChk__dBgS_LinkRoofChk_destructor_3(dBgS_LinkRoofChk * this);
void dBgS_MirLightLinChk__dBgS_MirLightLinChk_destructor_1(dBgS_MirLightLinChk * this);
void dBgS_MirLightLinChk__dBgS_MirLightLinChk_destructor_2(dBgS_MirLightLinChk * this);
void dBgS_MirLightLinChk__dBgS_MirLightLinChk_destructor_3(dBgS_MirLightLinChk * this);
...
undefined d_a_player_main__daPy_fanJointCallback(J3DNode * param_1, undefined4 param_2);
...
undefined daPy_lk_c__setEnemyWeaponAtParam(daPy_lk_c * this, int bIsLockOn);
...
daPy_swBlur_c__BlurColorType daPy_lk_c__getSwordBlurColor(daPy_lk_c * this);
undefined daPy_lk_c__setNormalCutAtParam(daPy_lk_c * this, daPy_py_c__PlayerAttackState attackState);
undefined daPy_lk_c__setFinishCutAtParam(daPy_lk_c * this, daPy_py_c__PlayerAttackState attackState);
undefined daPy_lk_c__setExtraCutAtParam(daPy_lk_c * this, daPy_py_c__PlayerAttackState attackState);
undefined daPy_lk_c__setExtraFinishCutAtParam(daPy_lk_c * this, daPy_py_c__PlayerAttackState attackState);
...
undefined daPy_py_c__setPlayerPosAndAngle_1(daPy_py_c * this, float * param_1);
undefined daPy_py_c__setPlayerPosAndAngle_2(daPy_py_c * this, cXyz * param_1, csXyz * param_2);
undefined daPy_py_c__setThrowDamage(daPy_py_c * this, cXyz * param_1, short param_2, float param_3, int param_4);
...
float daSea_WaterHeightInfo_Mng__GetHeight(daSea_WaterHeightInfo_Mng * this, float param_1, float param_2);
undefined d_a_sea__get_wave_max();
undefined daSea_WaterHeightInfo_Mng__GetHeight_1(daSea_WaterHeightInfo_Mng * this, int param_1, int param_2);
...
int d_a_sea__daSea_ChkAreaBeforePos(double param_1, double param_2);
int d_a_sea__daSea_ChkArea(float param_1, float param_2);
float d_a_sea__daSea_calcWave(double x, double z);
...
undefined J3DTevBlock__setTevKColor_2(J3DTevBlock * this, ulong param_1, J3DGXColor * param_2);
...
void dCamera_c__dCamera_c(dCamera_c * this, camera_class * pCamera);
...
undefined dCamera_c__onModeChange(dCamera_c * this, long cur, long next);
int dCamera_c__nextType(dCamera_c * this, int curType);
undefined dCamera_c__onTypeChange(dCamera_c * this, long cur, long next);
undefined dCamera_c__SetTypeForce(dCamera_c * this, char * param_1, fopAc_ac_c * param_2);
undefined dCamera_c__SetTypeForce_1(dCamera_c * this, long param_1, fopAc_ac_c * param_2);
undefined dCamera_c__onStyleChange(dCamera_c * this, long param_1, long param_2);
undefined dCamera_c__GetCameraTypeFromMapToolID(dCamera_c * this, long idx, long roomNo);
int dCamera_c__GetCameraTypeFromCameraName(dCamera_c * this, char * pName);
...
cXyz * dCamera_c__relationalPos_1(cXyz * __return_storage_ptr__, dCamera_c * this, fopAc_ac_c * param_1, cXyz * param_2, cSAngle param_3);
undefined dCamera_c__relationalPos_2(dCamera_c * this, fopAc_ac_c * param_1, fopAc_ac_c * param_2, cXyz * param_3, float param_4);
...
undefined dCamera_c__radiusActorInSight_1(dCamera_c * this, fopAc_ac_c * param_1, fopAc_ac_c * param_2, cXyz * param_3, cXyz * param_4, float param_5, short param_6);
...
undefined dCamera_c__lineBGCheck_1(dCamera_c * this, cXyz * param_1, cXyz * param_2, cXyz * param_3, ulong param_4);
undefined dCamera_c__lineBGCheck_2(dCamera_c * this, cXyz * param_1, cXyz * param_2, ulong param_3);
...
void dCamera_c__forwardCheckAngle(cSAngle * param_1, dCamera_c * param_2);
...
void cXyz__cXyz_3(cXyz * this, float param_1, float param_2, float param_3);
...
undefined dCamera_c__vomitCamera(dCamera_c * this, long styleIdx);
...
undefined dCamera_c__Set_5(dCamera_c * this, cXyz * param_1, cXyz * param_2, float param_3, short param_4);
undefined dCamera_c__Set_6(dCamera_c * this, cXyz * param_1, cXyz * param_2, short param_3, float param_4);
undefined dCamera_c__Reset(dCamera_c * this, cXyz * param_1, cXyz * param_2, float param_3, short param_4);
undefined dCamera_c__Reset_1(dCamera_c * this, cXyz * param_1, cXyz * param_2);
undefined dCamera_c__Reset_2(dCamera_c * this);
undefined dCamera_c__ResetView(dCamera_c * this);
undefined dCamera_c__Chtyp(dCamera_c * this, long nextType);
cSAngle dCamera_c__U2(dCamera_c * this);
...
undefined dCamera_c__SetBlureScale_1(dCamera_c * this, float param_1);
...
void d_camera__store(camera_class * pCamera);
undefined d_camera__camera_execute(undefined4 pCam);
undefined d_camera__camera_draw(undefined4 this);
undefined d_camera__init_phase1(camera_class * param_1);
undefined d_camera__init_phase2(undefined4 pCamera);
...
cXyz * daPy_py_c__getRopePos(cXyz * __return_storage_ptr__, daPy_py_c * this);
undefined dCamera_c__setFlag(dCamera_c * this, ulong param_1);
undefined dCamera_c__chkFlag(dCamera_c * this, ulong param_1);
cSAngle * dCamera_c__Bank(cSAngle * param_1, dCamera_c * param_2);
...
undefined dCamParam_c__Flag(dCamParam_c * this, long styleIdx, ushort mask);
...
void dBgS_CamGndChk__dBgS_CamGndChk_destructor_1(dBgS_CamGndChk * this);
void dBgS_CamGndChk__dBgS_CamGndChk_destructor_2(dBgS_CamGndChk * this);
void dBgS_CamGndChk__dBgS_CamGndChk_destructor_3(dBgS_CamGndChk * this);
void dBgS_CamLinChk__dBgS_CamLinChk_destructor_1(dBgS_CamLinChk * this);
void dBgS_CamLinChk__dBgS_CamLinChk_destructor_2(dBgS_CamLinChk * this);
void dBgS_CamLinChk__dBgS_CamLinChk_destructor_3(dBgS_CamLinChk * this);
void dBgS_CamLinChk_NorWtr__dBgS_CamLinChk_NorWtr_destructor_1(dBgS_CamLinChk_NorWtr * this);
void dBgS_CamLinChk_NorWtr__dBgS_CamLinChk_NorWtr_destructor_2(dBgS_CamLinChk_NorWtr * this);
void dBgS_CamLinChk_NorWtr__dBgS_CamLinChk_NorWtr_destructor_3(dBgS_CamLinChk_NorWtr * this);
void dBgS_CamGndChk_Wtr__dBgS_CamGndChk_Wtr_destructor_1(dBgS_CamGndChk_Wtr * this);
void dBgS_CamGndChk_Wtr__dBgS_CamGndChk_Wtr_destructor_2(dBgS_CamGndChk_Wtr * this);
void dBgS_CamGndChk_Wtr__dBgS_CamGndChk_Wtr_destructor_3(dBgS_CamGndChk_Wtr * this);
void dBgS_SphChk__dBgS_SphChk_destructor_1(dBgS_SphChk * this);
void dBgS_SphChk__dBgS_SphChk_destructor_2(dBgS_SphChk * this);
void dBgS_SphChk__dBgS_SphChk_destructor_3(dBgS_SphChk * this);
void dBgS_SphChk__dBgS_SphChk_destructor_4(dBgS_SphChk * this);
void dBgS_CamSphChk__dBgS_CamSphChk_destructor_1(dBgS_CamSphChk * this);
void dBgS_CamSphChk__dBgS_CamSphChk_destructor_2(dBgS_CamSphChk * this);
void dBgS_CamSphChk__dBgS_CamSphChk_destructor_3(dBgS_CamSphChk * this);
void dBgS_CamSphChk__dBgS_CamSphChk_destructor_4(dBgS_CamSphChk * this);
...
J2DPane * MyScreen__createPane(MyScreen * this, J2DScrnBlockHeader * pHeader, JSURandomInputStream * pStream, J2DPane * pParent);
J2DTypeID J2DScreen__getTypeID(J2DScreen * this);
...
undefined dKy_SordFlush_set(cXyz * pPos, undefined4 param_2);
...
undefined dMenu_Fmap_c__readFmapTexture(dMenu_Fmap_c * this, char * pFileName);
undefined dMenu_Fmap_c__aramCmapDatRead(dMenu_Fmap_c * this);
undefined dMenu_Fmap_c__initCmapDatPnt(dMenu_Fmap_c * this, aramCmapDatPat_t * pDat);
undefined dMenu_Fmap_c__getGridNumToCmapDatPnt(dMenu_Fmap_c * this, int param_1);
undefined dMenu_Fmap_c__setDispIslandPos(dMenu_Fmap_c * this, byte x, byte y);
undefined dMenu_Fmap_c__setIslandPos(dMenu_Fmap_c * this, fopMsgM_pane_class * param_1, float param_2, float param_3);
undefined dMenu_Fmap_c__changeFmapTexture(dMenu_Fmap_c * this, byte x, byte y);
...
FmapDataPntP * dMenu_Fmap2_c__getCmapDatPnt4(dMenu_Fmap2_c * this, int param_1);
...
undefined dMenu_Fmap2_c__isCompleteCollectMap(dMenu_Fmap2_c * this, byte id);
...
undefined d_menu_window__dMs_fmap_create(sub_ms_screen_class * this);
...
undefined d_menu_window__dMs_Create(sub_ms_screen_class * this);
...
undefined d_mesg__dMesg_fontsizeCenter_1();
...
void d_meter__dMenu_setMenuStatusOld(char param_1);
byte d_meter__dMenu_getMenuStatus(void);
...
undefined d_meter__dMeter_alphaControl(sub_meter_class * this);
undefined d_meter__dMeter_statusCheck();
undefined d_meter__dMeter_alphaClose();
undefined d_meter__dMeter_alphaOpen();
undefined d_meter__dMeter_rupy_num(undefined4 pDst, undefined2 num);
char * d_meter__dMeter_actionTex(ushort param_1);
...
undefined d_meter__dMeter_heart_data_set(fopMsgM_pane_class * param_1, fopMsgM_pane_class * param_2, fopMsgM_pane_class * param_3);
...
undefined d_meter__dMeter_setHeartScaleXY(undefined4 this, undefined2 scale);
undefined d_meter__dMeter_setHeartScaleXY2(undefined4 this, undefined2 scale);
...
undefined d_meter__dMeter_heartScaleInit(sub_meter_class * this);
undefined d_meter__dMeter_maxLifeChange();
undefined d_meter__dMeter_lifeChange(sub_meter_class * this, bool * param_2);
undefined d_meter__dMeter_heartLightMove(sub_meter_class * this);
undefined d_meter__dMeter_heartAlpha(sub_meter_class * this);
undefined d_meter__dMeter_heartInit(sub_meter_class * this);
undefined d_meter__dMeter_LifeMove(undefined4 this, bool bForce);
...
undefined d_meter__dMeter_weponInit(sub_meter_class * this);
undefined d_meter__dMeter_weponMove(sub_meter_class * this);
...
undefined d_meter__dMeter_actionChange(sub_meter_class * pMeter);
...
undefined d_meter__dMeter_rAlpha(sub_meter_class * this);
...
undefined d_meter__dMeter_rupyAlpha(sub_meter_class * param_1);
undefined d_meter__dMeter_rupyInit(sub_meter_class * this);
undefined d_meter__dMeter_rupyMove(undefined4 this);
undefined d_meter__dMeter_walletChange(sub_meter_class * this);
...
undefined d_meter__dMeter_clockMultiMove(sub_meter_class * this);
...
undefined d_meter__dMeter_screenDataSet(sub_meter_class * this);
...
undefined d_meter__dMeter_Draw(undefined4 this);
undefined d_meter__dMeter_Execute();
undefined d_meter__dMeter_IsDelete();
undefined d_meter__dMeter_Delete();
undefined d_meter__dMeter_Create(sub_meter_class * this);
...
undefined dNpc_PathRun_c__setInfDrct(dNpc_PathRun_c * this, dPath * pPath);
uint dNpc_PathRun_c__setInf(dNpc_PathRun_c * this, byte pathIndex, byte roomNo, bool bGoingForwards);
undefined dNpc_PathRun_c__nextPath(dNpc_PathRun_c * this, char roomNo);
void dNpc_PathRun_c__getPoint(cXyz * pDstPos, dNpc_PathRun_c * this, uchar pointIndex);
...
undefined dNpc_PathRun_c__pointArg(dNpc_PathRun_c * this, uchar idx);
...
undefined d_s_menu__dScnMenu_Draw(d_s_menu * param_1);
undefined d_s_menu__dScnMenu_Execute(d_s_menu * param_1);
undefined d_s_menu__dScnMenu_IsDelete();
undefined d_s_menu__dScnMenu_Delete(d_s_menu * param_1);
undefined d_s_menu__phase_1(d_s_menu * param_1);
int d_s_menu__phase_2(d_s_menu * param_1);
undefined d_s_menu__dScnMenu_Create(d_s_menu * param_1);
...
undefined d_s_play__phase_2(dScnPly_ply_c * pPly);
...
undefined d_s_title__dScnTitle_Create(scene_class * this);
...
undefined dTimer_c__start_1(dTimer_c * this, short param_1);
undefined dTimer_c__stock_start(dTimer_c * this);
undefined dTimer_c__stock_start_1(dTimer_c * this, short param_1);
...
int DynamicModuleControlBase__link(DynamicModuleControlBase * this);
...
JKRArchive * DynamicModuleControl__mountCallback(void * param_1);
...
void cMl__free(void * __ptr);
undefined cAPIGph_Painter();
undefined cAPIGph_BeforeOfDraw();
undefined cAPIGph_AfterOfDraw();
undefined cCcD_DivideInfo__Chk(cCcD_DivideInfo * this, cCcD_DivideInfo * pOther);
undefined cCcD_DivideArea__SetArea(cCcD_DivideArea * this, cM3dGAab * pAABB);
undefined cCcD_DivideArea__CalcDivideInfo(cCcD_DivideArea * this, cCcD_DivideInfo * pDst, cM3dGAab * pAABB, ulong bDisable);
undefined cCcD_DivideArea__CalcDivideInfoOverArea(cCcD_DivideArea * this, cCcD_DivideInfo * pDstInfo, cM3dGAab * pAABB);
undefined cCcD_Stts__GetGStts(cCcD_Stts * this);
undefined cCcD_Stts__GetGStts_1(cCcD_Stts * this);
...
undefined cCcD_Stts__PlusCcMove(cCcD_Stts * this, float x, float y, float z);
undefined cCcD_Obj__Set(cCcD_Obj * this, cCcD_SrcObj * pSrc);
undefined cCcD_TriAttr__CrossAtTg(cCcD_TriAttr * this, cCcD_CpsAttr * param_1, cXyz * param_2);
undefined cCcD_TriAttr__CrossAtTg_1(cCcD_TriAttr * this, cCcD_CylAttr * param_1, cXyz * param_2);
undefined cCcD_TriAttr__CrossAtTg_2(cCcD_TriAttr * this, cCcD_SphAttr * param_1, cXyz * param_2);
undefined cCcD_TriAttr__CrossAtTg_3(cCcD_TriAttr * this, cCcD_TriAttr * param_1, cXyz * param_2);
...
undefined cCcD_CpsAttr__CrossAtTg_3(cCcD_CpsAttr * this, cCcD_CpsAttr * param_1, cXyz * param_2);
undefined cCcD_CpsAttr__CrossAtTg_4(cCcD_CpsAttr * this, cCcD_CylAttr * param_1, cXyz * param_2);
undefined cCcD_CpsAttr__CrossAtTg_5(cCcD_CpsAttr * this, cCcD_SphAttr * param_1, cXyz * param_2);
undefined cCcD_CpsAttr__CrossAtTg_6(cCcD_CpsAttr * this, cCcD_TriAttr * param_1, cXyz * param_2);
undefined cCcD_CpsAttr__CrossCo_4(cCcD_CpsAttr * this, cCcD_CpsAttr * param_1, float * param_2);
undefined cCcD_CpsAttr__CrossCo_5(cCcD_CpsAttr * this, cCcD_CylAttr * param_1, float * param_2);
undefined cCcD_CpsAttr__CrossCo_6(cCcD_CpsAttr * this, cCcD_SphAttr * param_1, float * param_2);
...
undefined cCcD_CylAttr__CrossAtTg_3(cCcD_CylAttr * this, cCcD_CpsAttr * param_1, cXyz * param_2);
undefined cCcD_CylAttr__CrossAtTg_4(cCcD_CylAttr * this, cCcD_CylAttr * param_1, cXyz * param_2);
undefined cCcD_CylAttr__CrossAtTg_5(cCcD_CylAttr * this, cCcD_SphAttr * param_1, cXyz * param_2);
undefined cCcD_CylAttr__CrossAtTg_6(cCcD_CylAttr * this, cCcD_TriAttr * param_1, cXyz * param_2);
undefined cCcD_CylAttr__CrossCo_4(cCcD_CylAttr * this, cCcD_CylAttr * param_1, float * param_2);
undefined cCcD_CylAttr__CrossCo_5(cCcD_CylAttr * this, cCcD_SphAttr * param_1, float * param_2);
undefined cCcD_CylAttr__CrossCo_6(cCcD_CylAttr * this, cCcD_CpsAttr * param_1, float * param_2);
...
undefined cCcD_SphAttr__CrossAtTg_3(cCcD_SphAttr * this, cCcD_CpsAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossAtTg_4(cCcD_SphAttr * this, cCcD_CylAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossAtTg_5(cCcD_SphAttr * this, cCcD_SphAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossAtTg_6(cCcD_SphAttr * this, cCcD_TriAttr * param_1, cXyz * param_2);
undefined cCcD_SphAttr__CrossCo_4(cCcD_SphAttr * this, cCcD_CylAttr * param_1, float * param_2);
undefined cCcD_SphAttr__CrossCo_5(cCcD_SphAttr * this, cCcD_SphAttr * param_1, float * param_2);
undefined cCcD_SphAttr__CrossCo_6(cCcD_SphAttr * this, cCcD_CpsAttr * param_1, float * param_2);
...
undefined cCcD_TriAttr__CrossAtTg_4(cCcD_TriAttr * this, cCcD_AabAttr * param_1, cXyz * param_2);
undefined cCcD_TriAttr__CrossAtTg_5(cCcD_TriAttr * this, cCcD_PntAttr * param_1, cXyz * param_2);
undefined cCcD_TriAttr__CrossAtTg_6(cCcD_TriAttr * this, cCcD_ShapeAttr * param_1, cXyz * param_2);
undefined cCcD_TriAttr__CrossCo(cCcD_TriAttr * this, cCcD_SphAttr * param_1, float * param_2);
undefined cCcD_TriAttr__CrossCo_1(cCcD_TriAttr * this, cCcD_CylAttr * param_1, float * param_2);
undefined cCcD_TriAttr__CrossCo_2(cCcD_TriAttr * this, cCcD_AabAttr * param_1, float * param_2);
undefined cCcD_TriAttr__CrossCo_3(cCcD_TriAttr * this, cCcD_TriAttr * param_1, float * param_2);
undefined cCcD_TriAttr__CrossCo_4(cCcD_TriAttr * this, cCcD_CpsAttr * param_1, float * param_2);
undefined cCcD_TriAttr__CrossCo_5(cCcD_TriAttr * this, cCcD_PntAttr * param_1, float * param_2);
undefined cCcD_TriAttr__CrossCo_6(cCcD_TriAttr * this, cCcD_ShapeAttr * param_1, float * param_2);
...
void cCcD_TriAttr__cCcD_TriAttr_destructor_1(cCcD_TriAttr * this);
void cCcD_CpsAttr__cCcD_CpsAttr_destructor_1(cCcD_CpsAttr * this);
void cCcD_CylAttr__cCcD_CylAttr_destructor_1(cCcD_CylAttr * this);
void cCcD_SphAttr__cCcD_SphAttr_destructor_1(cCcD_SphAttr * this);
...
void cCcS__ClrTgHitInf(cCcS * this);
...
undefined cCcS__ChkNoHitCo(cCcS * this, cCcD_Obj * pObj1, cCcD_Obj * pObj2);
undefined cCcS__ChkCo(cCcS * this);
undefined cCcS__CalcTgPlusDmg(cCcS * this, cCcD_Obj * pAt, cCcD_Obj * pTg, cCcD_Stts * pAtStts, cCcD_Stts * pTgStts);
undefined cCcS__SetAtTgCommonHitInf(cCcS * this, cCcD_Obj * pAt, cCcD_Obj * pTg, cXyz * pCrossPos);
undefined cCcS__SetCoCommonHitInf(cCcS * this, cCcD_Obj * pObj1, cXyz * param_2, cCcD_Obj * pObj2, cXyz * param_4, float param_5);
...
undefined cLsIt_Method(node_list_class * param_1, undefined4 param_2, undefined4 param_3);
...
undefined cNdIt_Method(node_class * param_1, undefined4 param_2, undefined4 param_3);
...
undefined cTrIt_Method(node_lists_tree_class * param_1, undefined4 param_2, undefined4 param_3);
...
undefined cReq_Done(request_base_class * param_1);
...
int cTgIt_MethodCall(create_tag_class * param_1, pointer param_2);
undefined cTgIt_JudgeFilter(create_tag_class * param_1, undefined4 param_2);
...
undefined cXyz__operator_times_1(cXyz * this, Vec * param_1);
...
void csXyz__csXyz_2(csXyz * this, short param_1, short param_2, short param_3);
...
undefined cBgS__LineCross(cBgS * this, cBgS_LinChk * pChk);
double cBgS__GroundCross(cBgS * this, cBgS_GndChk * pChk);
cBgD_t * cBgS__ConvDzb(cBgD_t * pDt);
fopAc_ac_c * cBgS__GetActorPointer(cBgS * this, int actor_index);
dBgW * cBgS__GetBgWPointer(cBgS * this, cBgS_PolyInfo * param_1);
undefined cBgS__ChkPolySafe(cBgS * this, cBgS_PolyInfo * pPolyInf);
undefined cBgS__GetTriGrp(cBgS * this, int bg_index, int poly_index);
undefined cBgS__GetGrpToRoomId(cBgS * this, int bg_index, int grp);
cM3dGPla * cBgS__GetTriPla_1(cBgS * this, int bg_index, int poly_index);
...
undefined cBgS__GetGrpInf(cBgS * this, cBgS_PolyInfo * poly_info, int grp_id);
void cBgS_Chk__cBgS_Chk_destructor(cBgS_Chk * this);
bool cBgS_Chk__ChkSameActorPid(cBgS_Chk * this, uint param_1);
void cBgS_GndChk__cBgS_GndChk(cBgS_GndChk * this);
undefined cBgS_LinChk__ct(cBgS_LinChk * this);
undefined cBgS_LinChk__Set2(cBgS_LinChk * this, cXyz * pP0, cXyz * pP1, uint procID);
...
int cBgW__Set(cBgW * this, cBgD_t * pData, cBgW__Flag flags, MTX34 * pMtx);
...
int cBgW__LineCheckGrpRp(cBgW * this, cBgS_LinChk * pLinChk, int grp, int depth);
...
uint cBgW__GetGrpToRoomIndex(cBgW * this, int grp_index);
...
void cM2d_CrossCirLin(cM2dGCir * param_1, float param_2, float param_3, float param_4, float param_5, float * param_6, float * param_7);
...
undefined cM3d_CrossX_Tri_1();
undefined cM3d_CrossX_Tri_2();
undefined cM3d_CrossY_Tri();
undefined cM3d_CrossY_Tri_1();
undefined4 cM3d_CrossY_Tri_Front(cXyz * param_1, cXyz * param_2, cXyz * param_3, cXyz * pPos);
undefined cM3d_CrossY_Tri_3();
undefined cM3d_CrossY_Tri_4();
undefined cM3d_CrossY_Tri_5();
undefined cM3d_CrossZ_Tri();
undefined cM3d_CrossZ_Tri_1();
undefined cM3d_CrossZ_Tri_2();
...
undefined cM3d_lineVsPosSuisenCross_1();
undefined cM3d_2PlaneLinePosNearPos();
undefined cM3d_CrawVec(undefined4 pA, undefined4 pB, undefined4 pDst);
...
int cM3dGCyl__cross_1(cM3dGCyl * this, cM3dGCyl * param_1, float * param_2);
undefined cM3dGCyl__cross_2(cM3dGCyl * this, cM3dGCyl * param_1, cXyz * param_2);
undefined cM3dGCyl__cross_3(cM3dGCyl * this, cM3dGSph * param_1, float * param_2);
...
undefined cM3dGSph__cross_1(cM3dGSph * this, cM3dGCyl * param_1, cXyz * param_2);
undefined cM3dGSph__cross_2(cM3dGSph * this, cM3dGSph * param_1, float * param_2);
...
undefined cLib_addCalcAngleS2(short * pDst, short target, short speedRatio, short maxSpeed);
undefined cLib_addCalcAngleL();
undefined cLib_chaseUC();
undefined cLib_chaseS(undefined4 pDst, undefined2 target, undefined2 speed);
...
undefined MtxRotZ();
undefined MtxScale();
undefined MtxPosition(cXyz * pSrc, cXyz * pDst);
undefined MtxPush();
undefined MtxPull();
void cSAngle__cSAngle(cSAngle * this, cSAngle * param_1);
void cSAngle__cSAngle_2(cSAngle * this, short param_1);
void cSAngle__cSAngle_3(cSAngle * this, float param_1);
undefined cSAngle__Val(cSAngle * this, cSAngle * param_1);
undefined cSAngle__Val_1(cSAngle * this, short param_1);
undefined cSAngle__Val_2(cSAngle * this, float param_1);
...
undefined cSAngle__operator_minus_1(cSAngle * this, cSAngle * param_1);
...
undefined cSAngle__operator_plus_2(cSAngle * this, short param_1);
cSAngle * cSAngle__operator_minus_3(cSAngle * this, cSAngle * param_1, short param_2);
undefined cSAngle__operator_plus_set_1(cSAngle * this, short param_1);
undefined cSAngle__operator_minus_set_1(cSAngle * this, short param_1);
...
undefined cSPolar__Val_1(cSPolar * this, cXyz * param_1);
...
void cSGlobe__cSGlobe_2(cSGlobe * this, float param_1, short param_2, short param_3);
void cSGlobe__cSGlobe_3(cSGlobe * this, float param_1, cSAngle * param_2, cSAngle * param_3);
void cSGlobe__cSGlobe_4(cSGlobe * this, cXyz * param_1);
undefined cSGlobe__Formal(cSGlobe * this);
undefined cSGlobe__Val(cSGlobe * this, cSGlobe * param_1);
undefined cSGlobe__Val_1(cSGlobe * this, float param_1, short param_2, short param_3);
undefined cSGlobe__Val_2(cSGlobe * this, float param_1, cSAngle * param_2, cSAngle * param_3);
undefined cSGlobe__Val_3(cSGlobe * this, cXyz * param_1);
cXyz * cSGlobe__Xyz(cXyz * __return_storage_ptr__, cSGlobe * this);
...
undefined SStandard__sBs_FillArea_s(undefined4 param_1, undefined4 param_2, short param_3);
...
undefined JFWDisplay__clearEfb_2(JFWDisplay * this, int param_1, int param_2, int param_3, int param_4, _GXColor * param_5);
...
uint J3DUClipper__clip(J3DUClipper * this, MTX34 * pMtx, cXyz * pPos, float rad);
uint J3DUClipper__clip_1(J3DUClipper * this, MTX34 * param_1, cXyz * param_2, cXyz * param_3);
int J3DUClipper__clipByBox(J3DUClipper * this, J3DModel * pModel);
...
void JPABaseShapeArc__JPABaseShapeArc(JPABaseShapeArc * this, void * pData, JKRHeap * param_2);
...
undefined JPABaseShapeArc__getTextureIndex_1(JPABaseShapeArc * this);
...
undefined JPABaseShapeArc__getPrmColor_1(JPABaseShapeArc * this);
undefined JPABaseShapeArc__getEnvColor(JPABaseShapeArc * this, short param_1);
undefined JPABaseShapeArc__getEnvColor_1(JPABaseShapeArc * this);
...
void JPATextureArc__JPATextureArc(JPATextureArc * this, uchar * pData);
...
undefined JPATextureArc__load(JPATextureArc * this, _GXTexMapID texMap);
undefined JPATextureArc__getJUTTexture(JPATextureArc * this);
void JPATextureResource__JPATextureResource(JPATextureResource * this, ulong texNum, JKRHeap * pHeap);
undefined JPATextureResource__registration(JPATextureResource * this, JPATexture * pTexture);
void JPAEmitterResource__JPAEmitterResource(JPAEmitterResource * this, ulong capacity, JKRHeap * pHeap);
undefined JPAEmitterResource__registration(JPAEmitterResource * this, JPAEmitterData * param_1, ushort param_2);
JPAEmitterData * JPAEmitterResource__getByUserIndex(JPAEmitterResource * this, ushort param_1);
...
undefined JPABaseField__loadFieldData(JPABaseField * this, JPAFieldData * pData, JPAFieldBlock * pBlk);
undefined JPABaseField__calcVel(JPABaseField * this, JPAFieldData * pFieldData, JPABaseParticle * pPtcl);
undefined JPABaseField__calcFadeAffect(JPABaseField * this, JPAFieldData * pData, float time);
...
undefined JPAAirField__calc(JPAAirField * this, JPAFieldData * pData, JPABaseParticle * pPtcl);
...
int JPAFieldManager__init(JPAFieldManager * this, JPABaseParticle * pParticle);
...
undefined JPAEmitterManager__draw(JPAEmitterManager * this, JPADrawInfo * pDrawInfo, uchar groupID);
...
undefined JPADrawExecLoadDefaultTexture__exec(JPADrawExecLoadDefaultTexture * this, JPADrawContext * pDrawCtx);
...
undefined JPADrawExecSetTexMtx__exec_1(JPADrawExecSetTexMtx * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawExecLoadTexture__exec_1(JPADrawExecLoadTexture * this, JPADrawContext * param_1, JPABaseParticle * param_2);
...
undefined JPADraw__basePlaneTypeXZ(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, cXyz * param_5);
...
undefined JPADrawExecRotation__exec(JPADrawExecRotation * this, JPADrawContext * param_1, JPABaseParticle * pParticle);
...
undefined JPADrawCalcTextureAnmIndexNormal__calc(JPADrawCalcTextureAnmIndexNormal * this, JPADrawContext * pCtx);
...
undefined JPADrawExecCallBack__exec(JPADrawExecCallBack * this, JPADrawContext * pDC);
undefined JPADrawExecCallBack__exec_1(JPADrawExecCallBack * this, JPADrawContext * param_1, JPABaseParticle * param_2);
...
undefined JPADrawCalcColorPrm__calc_1(JPADrawCalcColorPrm * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcColorEnv__calc_1(JPADrawCalcColorEnv * this, JPADrawContext * param_1, JPABaseParticle * param_2);
...
undefined JPADrawCalcColorAnmFrameNormal__calc_1(JPADrawCalcColorAnmFrameNormal * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcColorAnmFrameRepeat__calc_1(JPADrawCalcColorAnmFrameRepeat * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcColorAnmFrameReverse__calc_1(JPADrawCalcColorAnmFrameReverse * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcColorAnmFrameMerge__calc_1(JPADrawCalcColorAnmFrameMerge * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcColorAnmFrameRandom__calc_1(JPADrawCalcColorAnmFrameRandom * this, JPADrawContext * param_1, JPABaseParticle * param_2);
...
undefined JPADrawCalcTextureAnmIndexNormal__calc_1(JPADrawCalcTextureAnmIndexNormal * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcTextureAnmIndexRepeat__calc_1(JPADrawCalcTextureAnmIndexRepeat * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcTextureAnmIndexReverse__calc_1(JPADrawCalcTextureAnmIndexReverse * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcTextureAnmIndexMerge__calc_1(JPADrawCalcTextureAnmIndexMerge * this, JPADrawContext * param_1, JPABaseParticle * param_2);
undefined JPADrawCalcTextureAnmIndexRandom__calc_1(JPADrawCalcTextureAnmIndexRandom * this, JPADrawContext * param_1, JPABaseParticle * param_2);
...
undefined JPADrawExecSetTexMtx__exec_2(JPADrawExecSetTexMtx * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawExecSetTexMtx__JPADrawExecSetTexMtx_destructor_1(JPADrawExecSetTexMtx * this);
undefined JPADrawExecLoadTexture__exec_2(JPADrawExecLoadTexture * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawExecLoadTexture__JPADrawExecLoadTexture_destructor_1(JPADrawExecLoadTexture * this);
undefined JPADrawCalcColorPrm__calc_2(JPADrawCalcColorPrm * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorPrm__JPADrawCalcColorPrm_destructor_1(JPADrawCalcColorPrm * this);
undefined JPADrawCalcColorEnv__calc_2(JPADrawCalcColorEnv * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorEnv__JPADrawCalcColorEnv_destructor_1(JPADrawCalcColorEnv * this);
undefined JPADrawCalcColorAnmFrameNormal__calc_2(JPADrawCalcColorAnmFrameNormal * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorAnmFrameNormal__JPADrawCalcColorAnmFrameNormal_destructor_1(JPADrawCalcColorAnmFrameNormal * this);
undefined JPADrawCalcColorAnmFrameRepeat__calc_2(JPADrawCalcColorAnmFrameRepeat * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorAnmFrameRepeat__JPADrawCalcColorAnmFrameRepeat_destructor_1(JPADrawCalcColorAnmFrameRepeat * this);
undefined JPADrawCalcColorAnmFrameReverse__calc_2(JPADrawCalcColorAnmFrameReverse * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorAnmFrameReverse__JPADrawCalcColorAnmFrameReverse_destructor_1(JPADrawCalcColorAnmFrameReverse * this);
undefined JPADrawCalcColorAnmFrameMerge__calc_2(JPADrawCalcColorAnmFrameMerge * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorAnmFrameMerge__JPADrawCalcColorAnmFrameMerge_destructor_1(JPADrawCalcColorAnmFrameMerge * this);
undefined JPADrawCalcColorAnmFrameRandom__calc_2(JPADrawCalcColorAnmFrameRandom * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcColorAnmFrameRandom__JPADrawCalcColorAnmFrameRandom_destructor_1(JPADrawCalcColorAnmFrameRandom * this);
undefined JPADrawCalcTextureAnmIndexNormal__calc_2(JPADrawCalcTextureAnmIndexNormal * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcTextureAnmIndexNormal__JPADrawCalcTextureAnmIndexNormal_destructor_1(JPADrawCalcTextureAnmIndexNormal * this);
undefined JPADrawCalcTextureAnmIndexRepeat__calc_2(JPADrawCalcTextureAnmIndexRepeat * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcTextureAnmIndexRepeat__JPADrawCalcTextureAnmIndexRepeat_destructor_1(JPADrawCalcTextureAnmIndexRepeat * this);
undefined JPADrawCalcTextureAnmIndexReverse__calc_2(JPADrawCalcTextureAnmIndexReverse * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcTextureAnmIndexReverse__JPADrawCalcTextureAnmIndexReverse_destructor_1(JPADrawCalcTextureAnmIndexReverse * this);
undefined JPADrawCalcTextureAnmIndexMerge__calc_2(JPADrawCalcTextureAnmIndexMerge * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcTextureAnmIndexMerge__JPADrawCalcTextureAnmIndexMerge_destructor_1(JPADrawCalcTextureAnmIndexMerge * this);
undefined JPADrawCalcTextureAnmIndexRandom__calc_2(JPADrawCalcTextureAnmIndexRandom * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawCalcTextureAnmIndexRandom__JPADrawCalcTextureAnmIndexRandom_destructor_1(JPADrawCalcTextureAnmIndexRandom * this);
undefined JPADrawExecCallBack__exec_2(JPADrawExecCallBack * this, JPADrawContext * param_1, JPABaseParticle * param_2);
void JPADrawExecCallBack__JPADrawExecCallBack_destructor_1(JPADrawExecCallBack * this);
undefined JPADraw__initialize(JPADraw * this, JPABaseEmitter * pEmitter, JPATextureResource * pTexRes);
undefined JPADraw__draw(JPADraw * this, MTX34 * pMtx);
...
undefined JPADraw__initParticle(JPADraw * this, JPABaseParticle * pPtcl);
undefined JPADraw__initChild(JPADraw * this, JPABaseParticle * param_1, JPABaseParticle * param_2);
undefined4 JPADraw__loadTexture(JPADraw * this, byte tex_no, _GXTexMapID slot);
undefined JPADraw__setDrawExecVisitorsBeforeCB(JPADraw * this, JPADrawVisitorDefFlags * pFlags);
undefined JPADraw__setDrawExecVisitorsAfterCB(JPADraw * this, JPADrawVisitorDefFlags * param_1);
undefined JPADraw__setDrawCalcVisitors(JPADraw * this, JPADrawVisitorDefFlags * pFlags);
...
undefined JPADraw__loadYBBMtx(JPADraw * this, MTX34 * param_1);
...
undefined JPADrawSetupTev__setupTev(JPADrawSetupTev * this, JPABaseShapeArc * pSHP1, JPAExTexShapeArc * pEXT1);
...
void JStudio__TParse__TParse(TParse * this, TControl * pControl);
void JStudio__TParse__TParse_destructor(TParse * this);
undefined JStudio__TParse__parseHeader(TParse * this, TParse_THeader * pHeader, ulong size);
...
undefined JGadget__findUpperBound_binary_current_1(JGadget * this, TIterator_data_ param_1, TIterator_data_ param_2, TIterator_data_ param_3, double * param_4, less__double__ param_5);
undefined JGadget__findUpperBound_binary_current_2(JGadget * this, TIterator_data_ param_1, TIterator_data_ param_2, TIterator_data_ param_3, double * param_4);
undefined JGadget__findUpperBound_binary_current_3(JGadget * this, TIterator_data_ param_1, TIterator_data_ param_2, TIterator_data_ param_3, double * param_4, less__double__ param_5);
...
undefined std__upper_bound_1(std * this, TIterator_data_ param_1, TIterator_data_ param_2, double * param_3, less__double__ param_4);
...
void JStudio__stb__TObject__TObject_1(TObject * this, TParse_TBlock_object * param_1);
...
undefined JStudio__stb__TParse__parseHeader_next(TParse * this, void * * ppData, ulong * param_2, ulong size);
...
undefined std__find_if_1(std * this, iterator param_1, iterator param_2, TPRObject_ID_equal param_3);
...
undefined JStudio_JStage___unnamed_control_cpp___createObject_JSG__1(_unnamed_control_cpp_ * this, TParse_TBlock_object * param_1, TObject * param_2, TSystem * param_3);
undefined JStudio_JStage___unnamed_control_cpp___createObject_JSG__2(_unnamed_control_cpp_ * this, TParse_TBlock_object * param_1, TObject * param_2, TSystem * param_3);
undefined JStudio_JStage___unnamed_control_cpp___createObject_JSG__3(_unnamed_control_cpp_ * this, TParse_TBlock_object * param_1, TObject * param_2, TSystem * param_3);
undefined JStudio_JStage___unnamed_control_cpp___createObject_JSG__4(_unnamed_control_cpp_ * this, TParse_TBlock_object * param_1, TObject * param_2, TSystem * param_3);
...
undefined JASystem__TSeqParser__cmdWait_1(TSeqParser * this, TTrack * param_1, uchar param_2);
...
undefined JASystem__TBasicInst__TKeymap__getVeloRegion_1(TKeymap * this, int param_1);
...
undefined JAudio__JSUConvertOffsetToPtr_1();
undefined JAudio__JSUConvertOffsetToPtr_2();
undefined JAudio__JSUConvertOffsetToPtr_3();
undefined JAudio__JSUConvertOffsetToPtr_4();
undefined JAudio__JSUConvertOffsetToPtr_5();
undefined JAudio__JSUConvertOffsetToPtr_6();
...
undefined JAudio__JSUConvertOffsetToPtr_7();
undefined JAudio__JSUConvertOffsetToPtr_8();
undefined JAudio__JSUConvertOffsetToPtr_9();
undefined JAudio__JSUConvertOffsetToPtr_10();
undefined JAudio__JSUConvertOffsetToPtr_11();
undefined JAudio__JSUConvertOffsetToPtr_12();
undefined JAudio__JSUConvertOffsetToPtr_13();
undefined JAudio__JSUConvertOffsetToPtr_14();
undefined JAudio__JSUConvertOffsetToPtr_15();
...
void JASystem__TDSPChannel__free_1(TDSPChannel * this, void * __ptr);
...
undefined JAIAnimeSound__initActorAnimSound(JAIAnimeSound * this, void * pData, ulong direction, float loopFrame);
undefined JAIAnimeSound__setAnimSoundVec(JAIAnimeSound * this, JAIBasic * param_1, cXyz * param_2, float time, float speed, ulong param_5, uchar param_6);
undefined JAIAnimeSound__setAnimSoundActor(JAIAnimeSound * this, JAIBasic * pBasic, Actor * pActor, float time, float speed, uchar param_5);
undefined JAIAnimeSound__playActorAnimSound(JAIAnimeSound * this, JAIBasic * pBasic, Actor * pActor, float speed, uchar param_4);
void JAIAnimeSound__startAnimSound(JAIAnimeSound * this, void * param_1, ulong param_2, JAISound * * param_3, Actor * param_4, uchar param_5);
...
void JAIBasic__startSoundVec(JAIBasic * this, JAISoundInfoID param_1, JAISound * * param_2, Vec * param_3, ulong param_4, ulong param_5, uchar param_6);
void JAIBasic__startSoundActor(JAIBasic * this, JAISoundInfoID param_1, JAISound * * param_2, Actor * param_3, ulong param_4, uchar param_5);
void JAIBasic__startSoundDirectID(JAIBasic * this, ulong param_1, JAISound * * param_2, Actor * param_3, ulong param_4, uchar param_5);
void JAIBasic__startSoundBasic(JAIBasic * this, ulong param_1, JAISound * * param_2, Actor * param_3, ulong param_4, uchar param_5, void * param_6);
...
undefined JAIBasic__stopAllSound_1(JAIBasic * this, ulong param_1);
undefined JAIBasic__stopAllSound_2(JAIBasic * this, ulong param_1, void * param_2);
...
undefined JAISound__setVolume(JAISound * this, float param_1, ulong param_2, byte param_3);
...
void JAInter__StreamMgr__storeStreamBuffer(JAISound * * param_1, Actor * param_2, ulong param_3, ulong param_4, uchar param_5, void * param_6);
...
undefined JAIZelBasic__setCameraGroupInfo(JAIZelBasic * this, byte newSeaFloorGroupInfo);
undefined JAIZelBasic__changeSeaBgm(JAIZelBasic * this);
undefined JAIZelBasic__startIsleBgm(JAIZelBasic * this);
undefined JAIZelBasic__setLinkGroupInfo(JAIZelBasic * this, uchar newSeaFloorGroupInfo);
...
undefined JAIZelAnime__setAnimSound(JAIZelAnime * this, cXyz * pPos, float time, float speed, ulong param_4, char param_5);
...
void JKRHeap__JKRHeap(JKRHeap * this, void * pData, ulong size, JKRHeap * pParent, bool pReportErrors);
void JKRHeap__JKRHeap_destructor(JKRHeap * this);
bool JKRHeap__initArena(char * * param_1, ulong * param_2, int param_3);
...
undefined JKRHeap__alloc(ulong size, int param_2, JKRHeap * pHeap);
void * JKRHeap__alloc_1(JKRHeap * this, ulong size, int param_2);
void JKRHeap__free(void * __ptr, JKRHeap * param_2);
void JKRHeap__free_1(JKRHeap * this, void * __ptr);
...
undefined JKRHeap__resize(void * param_1, ulong param_2, JKRHeap * param_3);
undefined JKRHeap__resize_1(JKRHeap * this, void * param_1, ulong param_2);
int JKRHeap__getSize(void * param_1, JKRHeap * param_2);
int JKRHeap__getSize_1(JKRHeap * this, JKRArchive__Header * param_1);
...
JKRHeap * JKRHeap__find(JKRHeap * this, void * pPtr);
...
undefined JKRHeap__dispose_2(JKRHeap * this, void * param_1, void * param_2);
undefined JKRHeap__dispose_3(JKRHeap * this);
undefined JKRHeap__copyMemory(void * pDst, void * pSrc, ulong size);
...
void * JKernel__operator_new_1(ulong size, undefined4 param_2);
void * JKernel__operator_new_2(ulong size, JKRHeap * heap, undefined4 align);
undefined JKernel__operator_new_array();
undefined JKernel__operator_new_array_1();
undefined JKernel__operator_new_array_2();
...
undefined JKRExpHeap__allocFromHead_1(JKRExpHeap * this, ulong param_1);
undefined JKRExpHeap__allocFromTail(JKRExpHeap * this, ulong param_1, int param_2);
undefined JKRExpHeap__allocFromTail_1(JKRExpHeap * this, ulong param_1);
...
int JKRExpHeap__do_getSize(JKRExpHeap * this, void * param_1);
...
JKRSolidHeap * JKRSolidHeap__create(ulong maxSize, JKRHeap * pParent, bool bReportErrors);
...
undefined JKRSolidHeap__allocFromHead(JKRSolidHeap * this, ulong size, int align);
undefined JKRSolidHeap__allocFromTail(JKRSolidHeap * this, ulong size, int align);
...
int JKRSolidHeap__do_getSize(JKRSolidHeap * this, void * param_1);
...
void JKRThread__JKRThread(JKRThread * this, ulong stackSize, int msgCount, int prio);
void JKRThread__JKRThread_1(JKRThread * this, OSThread * param_1, int param_2);
...
void JKRAram__JKRAram(JKRAram * this, ulong audioSize, ulong graphSize, long prio);
void JKRAram__JKRAram_destructor(JKRAram * this);
undefined JKRAram__run(JKRAram * this);
undefined JKRAram__checkOkAddress(void * param_1, ulong param_2, JKRAramBlock * pBlock, ulong param_4);
undefined JKRAram__changeGroupIdIfNeed(uchar * param_1, int groupId);
void * JKRAram__mainRamToAram(uchar * pSrcData, ulong param_2, ulong param_3, JKRExpandSwitch param_4, ulong param_5, JKRHeap * pHeap, int param_7);
undefined JKRAram__mainRamToAram_1(JKRAram * this, uchar * param_1, JKRAramBlock * param_2, ulong param_3, JKRExpandSwitch param_4, ulong param_5, JKRHeap * param_6, int param_7);
undefined JKRAram__aramToMainRam(ulong param_1, uchar * pDst, ulong param_3, JKRExpandSwitch param_4, ulong dstSize_, JKRHeap * pHeap, int param_7, ulong * param_8);
undefined JKRAram__aramToMainRam_1(JKRAramBlock * param_1, uchar * param_2, ulong param_3, ulong param_4, JKRExpandSwitch param_5, ulong param_6, JKRHeap * param_7, int param_8, ulong * param_9);
undefined JKernel__JKRDecompressFromAramToMainRam();
undefined JKernel__decompSZS_subroutine(undefined4 src, undefined4 dst);
...
JKRAMCommand * JKRAramPiece__prepareCommand(int dir, ulong src, ulong dst, ulong len, JKRAramBlock * param_5, void * param_6);
void JKRAramPiece__sendCommand(JKRAMCommand * pCmd);
JKRAMCommand * JKRAramPiece__orderAsync(int dir, ulong src, ulong dst, ulong len, JKRAramBlock * pBlock, void * param_6);
void JKRAramPiece__sync(JKRAMCommand * cmd, int dir);
JKRAramPiece * JKRAramPiece__orderSync(int param_1, ulong param_2, ulong param_3, ulong param_4, JKRAramBlock * pBlock);
undefined JKRAramPiece__startDMA(JKRAMCommand * pCmd);
void JKRAramPiece__doneDMA(JKRAMCommand * pCmd);
...
undefined JKRAramStream__write_StreamToAram_Async(JSUFileInputStream * param_1, ulong param_2, ulong param_3, ulong param_4);
...
int JKRFileLoader__getGlbResource_1(char * param_1, JKRFileLoader * param_2);
undefined4 JKRFileLoader__removeResource(void * param_1, JKRFileLoader * param_2);
undefined4 JKRFileLoader__detachResource(void * pData, JKRFileLoader * pFileLoader);
...
JKRFileCache * JKRFileCache__mount(char * param_1, JKRHeap * param_2, char * param_3);
...
undefined JKRFileCache__getResource_1(JKRFileCache * this, ulong param_1, char * param_2);
undefined JKRFileCache__readResource(JKRFileCache * this, void * param_1, ulong param_2, char * param_3);
undefined JKRFileCache__readResource_1(JKRFileCache * this, void * param_1, ulong param_2, ulong param_3, char * param_4);
...
undefined JKRFileCache__findCacheBlock_1(JKRFileCache * this, ulong param_1);
...
JKRArchive * JKRArchive__mount(char * pPath, EMountMode mode, JKRHeap * pHeap, EMountDirection dir);
int JKRArchive__mount_1(long param_1, EMountMode mountMode, JKRHeap * param_3, EMountDirection param_4);
...
int JKRArchive__getGlbResource(ulong resID, char * pName, JKRArchive * pArchive);
undefined JKRArchive__getResource(JKRArchive * this, char * param_1);
undefined JKRArchive__getResource_1(JKRArchive * this, ulong param_1, char * param_2);
...
undefined JKRArchive__readResource_1(JKRArchive * this, void * param_1, ulong param_2, char * param_3);
int JKRArchive__readIdxResource(JKRArchive * this, void * param_1, ulong param_2, ulong param_3);
undefined JKRArchive__readResource_2(JKRArchive * this, void * param_1, ulong param_2, ushort param_3);
...
void JKRArchive__JKRArchive_1(JKRArchive * this, long param_1, EMountMode param_2);
...
undefined JKRArchive__CArcName__store_1(CArcName * this, char * param_1, char param_2);
...
void JKRMemArchive__JKRMemArchive_1(JKRMemArchive * this, long param_1, EMountDirection param_2);
...
int JKRMemArchive__open_1(JKRMemArchive * this, char * __file, int __oflag, ...);
undefined JKRMemArchive__fetchResource(JKRMemArchive * this, SDIFileEntry * param_1, ulong * param_2);
undefined JKRMemArchive__fetchResource_1(JKRMemArchive * this, void * param_1, ulong param_2, SDIFileEntry * param_3, ulong * param_4);
...
undefined JKRMemArchive__fetchResource_subroutine(uchar * param_1, ulong param_2, uchar * param_3, ulong param_4, int param_5);
...
undefined JKRAramArchive__fetchResource_1(JKRAramArchive * this, void * param_1, ulong param_2, SDIFileEntry * param_3, ulong * param_4);
undefined JKRAramArchive__fetchResource_subroutine(ulong param_1, ulong param_2, uchar * param_3, ulong param_4, int param_5);
ulong JKRAramArchive__fetchResource_subroutine_1(ulong param_1, ulong inSize, JKRHeap * pHeap, int param_4, uchar * * pData);
...
undefined JKRDvdArchive__fetchResource_1(JKRDvdArchive * this, void * param_1, ulong param_2, SDIFileEntry * fileEntry, ulong * param_4);
undefined JKRDvdArchive__fetchResource_subroutine(long fileID, ulong offset, ulong dstSize, uchar * pDstData, ulong param_5, int param_6, int cmpr);
undefined JKRDvdArchive__fetchResource_subroutine_1(long param_1, ulong param_2, ulong param_3, JKRHeap * param_4, int param_5, int param_6, uchar * * param_7);
undefined JKRDvdArchive__getExpandedResSize(JKRDvdArchive * this, void * param_1);
void JKRCompArchive__JKRCompArchive(JKRCompArchive * this, long fileNo, EMountDirection dir);
void JKRCompArchive__JKRCompArchive_destructor(JKRCompArchive * this);
int JKRCompArchive__open(JKRCompArchive * this, int fileNo);
undefined JKRCompArchive__fetchResource(JKRCompArchive * this, SDIFileEntry * pFile, ulong * pDstSize);
undefined JKRCompArchive__fetchResource_1(JKRCompArchive * this, uchar * pDstData, ulong size, SDIFileEntry * pFile, ulong * pDstSize);
...
undefined JKRCompArchive__getExpandedResSize(JKRCompArchive * this, uchar * pData);
ssize_t JKRFile__read(JKRFile * this, int __fd, void * __buf, size_t __nbytes);
void JKRDvdFile__JKRDvdFile(JKRDvdFile * this);
void JKRDvdFile__JKRDvdFile_1(JKRDvdFile * this, char * param_1);
void JKRDvdFile__JKRDvdFile_2(JKRDvdFile * this, long param_1);
...
int JKRDvdFile__open_1(JKRDvdFile * this, int num);
...
uchar * JKRDvdRipper__loadToMainRAM_1(long fileID, uchar * pDstData, JKRExpandSwitch expandSwitch_, ulong dstSize, JKRHeap * pHeap, EAllocDirection dir, ulong offset, int * pDstCompType);
uchar * JKRDvdRipper__loadToMainRAM_2(JKRDvdFile * pFile, uchar * pDstData, JKRExpandSwitch expandSwitch, ulong dstSize, JKRHeap * pHeap, EAllocDirection dir, ulong offset, int * pDstCompType);
undefined JKernel__JKRDecompressFromDVD(undefined4 param_1, undefined4 pDst, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6);
undefined JKernel__decompSZS_subroutine_1(undefined4 src, undefined4 dst);
void * JKernel__firstSrcData_1(void);
undefined JKernel__nextSrcData_1();
...
undefined JKRDvdAramRipper__loadToAram(long fileNo, ulong param_2, JKRExpandSwitch param_3, ulong param_4, ulong param_5);
uchar * JKRDvdAramRipper__loadToAram_1(JKRDvdFile * pFile, ulong param_2, JKRExpandSwitch expand, ulong param_4, ulong param_5);
JKRADCommand * JKRDvdAramRipper__loadToAram_Async(JKRDvdFile * pDvdFile, ulong param_2, JKRExpandSwitch ex, void * param_4, ulong param_5, ulong param_6);
void JKRDvdAramRipper__callCommand_Async(JKRADCommand * pCmd);
void JSUFileInputStream__JSUFileInputStream_destructor(JSUFileInputStream * this);
undefined JKRDvdAramRipper__syncAram(JKRADCommand * pCmd, int param_2);
void JKRADCommand__JKRADCommand(JKRADCommand * this);
void JKRADCommand__JKRADCommand_destructor(JKRADCommand * this);
undefined JKernel__JKRDecompressFromDVDToAram(JKRDvdFile * srcFile, int size, undefined4 fileSize, int maxDest, int fileOffset, undefined4 srcOffset);
undefined JKernel__decompSZS_subroutine_2(undefined4 buf, undefined4 size);
byte * JKernel__firstSrcData_2(void);
byte * JKernel__nextSrcData_2(byte * s);
...
JKRDecompCommand * JKRDecomp__prepareCommand(uchar * pSrc, uchar * pDst, ulong dstSize, ulong srcOffs, void * pCallBack);
undefined JKRDecomp__sendCommand(JKRDecompCommand * pCmd);
JKRDecompCommand * JKRDecomp__orderAsync(uchar * pSrc, uchar * pDst, ulong dstSize, ulong srcOffs, void * pCallBack);
void JKRDecomp__sync(JKRDecompCommand * pCmd, int param_2);
undefined JKRDecomp__orderSync(uchar * pSrc, uchar * pDst, ulong dstSize, ulong srcOffs);
undefined JKRDecomp__decode(uchar * pSrc, uchar * pDst, ulong dstSize, ulong offs);
undefined JKRDecomp__decodeSZP(uchar * s, uchar * d, ulong dstSize, ulong offs);
undefined JKRDecomp__decodeSZS(uchar * param_1, uchar * param_2, ulong param_3, ulong param_4);
JKRDecomp__CompressionType JKRDecomp__checkCompressed(uchar * param_1);
...
undefined JSUPtrList__append(JSUPtrList * this, JSUPtrLink * pLink);
...
undefined JGadget__binary__TParse_header_block__parse_next(TParse_header_block * this, void * * pData, ulong mode);
...
undefined JGadget__TNodeLinkList__erase_1(TNodeLinkList * this, iterator param_1, iterator param_2);
...
undefined JGadget__TVector__void_star_JGadget__TAllocator__void_star______insert_1(TVector__void_star_JGadget__TAllocator__void_star____ * this, void * * param_1, void * * param_2);
...
undefined JUTResReference__getResource_1(JUTResReference * this, ulong param_1, JKRArchive * param_2);
void JUTTexture__JUTTexture_destructor(JUTTexture * this, short flag);
...
undefined JUTTexture__initTexObj_1(JUTTexture * this, _GXTlut param_1);
...
undefined JUTPalette__storeTLUT_1(JUTPalette * this, _GXTlut param_1, _GXTlutFmt param_2, JUTTransparency param_3, ushort param_4, void * param_5);
undefined JUTPalette__load(JUTPalette * this);
void JUTNameTab__JUTNameTab(JUTNameTab * this);
void JUTNameTab__JUTNameTab_2(JUTNameTab * this, ResNTAB * param_1);
...
undefined JUTFont__setCharColor(JUTFont * this, _GXColor * pColor);
undefined JUTFont__setGradColor(JUTFont * this, _GXColor * pColorTop, _GXColor * pColorBottom);
...
void JUTResFont__JUTResFont_1(JUTResFont * this, ResFONT * param_1, JKRHeap * param_2);
...
undefined JUTResFont__setGX_1(JUTResFont * this, TColor param_1, TColor param_2);
...
undefined JUTResFont__loadFont(JUTResFont * this, int code, _GXTexMapID texMapID, TWidth * pDstWidth);
undefined JUTResFont__getWidthEntry(JUTResFont * this, int code, TWidth * pWidth);
...
uint JUTResFont__getFontCode(JUTResFont * this, int code);
...
undefined JUtility__JUTReport_1();
...
void JUTGamePad__init(void);
void JUTGamePad__read(JUTGamePad * this);
...
undefined JUTGamePad__CRumble__clear_1(CRumble * this, JUTGamePad * param_1);
...
JUTException * JUTException__create(JUTDirectPrint * param_1);
...
void JUTDirectPrint__start(JUTDirectPrint * this);
...
undefined JUTAssertion__create(void);
...
undefined JUTAssertion__setWarningMessage_f(ulong param_1, char * param_2, int param_3, char * param_4, ...);
...
undefined JUTConsole__create_1(JUTConsole * this, uint param_1, void * param_2, ulong param_3);
...
undefined J2DGrafContext__place(J2DGrafContext * this, TBox2__float__ * pPos);
...
void J2DGrafContext__J2DGrafContext_destructor(J2DGrafContext * this, short flag);
undefined J2DGrafContext__place_1(J2DGrafContext * this, float param_1, float param_2, float param_3, float param_4);
J2DTypeID J2DGrafContext__getGrafType(J2DGrafContext * this);
undefined J2DGrafContext__setLookat(J2DGrafContext * this);
void J2DOrthoGraph__J2DOrthoGraph(J2DOrthoGraph * this);
void J2DOrthoGraph__J2DOrthoGraph_2(J2DOrthoGraph * this, float param_1, float param_2, float param_3, float param_4, float param_5, float param_6);
...
undefined J2DGraph__J2DFillBox_1();
undefined J2DGraph__J2DDrawFrame();
undefined J2DGraph__J2DDrawFrame_1();
J2DTypeID J2DOrthoGraph__getGrafType(J2DOrthoGraph * this);
...
undefined J2DPrint__printReturn(J2DPrint * this, char * param_1, float param_2, float param_3, J2DTextBoxHBindingType hBinding, J2DTextBoxVBindingType vBinding, float param_6, float param_7, uchar param_8);
undefined J2DPrint__parse(J2DPrint * this, uchar * pText, int param_2, int param_3, ushort * param_4, TSize * pDstSize, uchar alpha, bool param_7);
...
void J2DPrint__J2DPrint_destructor(J2DPrint * this, short flag);
void J2DPane__J2DPane(J2DPane * this);
void J2DPane__J2DPane_1(J2DPane * this, J2DPane * param_1, bool param_2, ulong param_3, TBox2__float__ * param_4);
void J2DPane__J2DPane_2(J2DPane * this, ulong param_1, TBox2__float__ * param_2);
undefined J2DPane__initiate(J2DPane * this);
void J2DPane__J2DPane_3(J2DPane * this, J2DPane * pParentPane, JSURandomInputStream * pStream);
undefined J2DPane__makePaneStream(J2DPane * this, J2DPane * pParentPane, JSURandomInputStream * pStream);
void J2DPane__J2DPane_destructor(J2DPane * this, short flag);
undefined J2DPane__insertChild(J2DPane * this, J2DPane * param_1, J2DPane * param_2);
undefined J2DPane__draw(J2DPane * this, float param_1, float param_2, J2DGrafContext * pCtx, bool bClip);
...
undefined J2DPane__drawSelf_1(J2DPane * this, float param_1, float param_2, float * param_3);
J2DTypeID J2DPane__getTypeID(J2DPane * this);
void J2DScreen__J2DScreen_destructor(J2DScreen * this, short flag);
...
undefined J2DScreen__createPane(J2DScreen * this, J2DScrnBlockHeader * pHeader, JSURandomInputStream * pStream, J2DPane * pPane);
undefined J2DScreen__set_1(J2DScreen * this, JSURandomInputStream * param_1);
...
undefined J2DScreen__draw(J2DScreen * this, float x, float y, J2DGrafContext * pCtx);
undefined J2DScreen__search(J2DScreen * this, ulong param_1);
void J2DScreen__drawSelf(J2DScreen * this, float param_1, float param_2, MTX34 * param_3);
...
void J2DWindow__J2DWindow_destructor(J2DWindow * this, short flag);
...
undefined J2DWindow__drawSelf_1(J2DWindow * this, float param_1, float param_2, float * param_3);
...
undefined J2DWindow__drawFrameTexture_1(J2DWindow * this, JUTTexture * param_1, float param_2, float param_3, bool param_4, bool param_5, bool param_6);
...
J2DTypeID J2DWindow__getTypeID(J2DWindow * this);
void J2DPicture__J2DPicture(J2DPicture * this);
void J2DPicture__J2DPicture_1(J2DPicture * this, J2DPane * param_1, JSURandomInputStream * param_2);
void J2DPicture__J2DPicture_2(J2DPicture * this, ResTIMG * param_1);
void J2DPicture__J2DPicture_3(J2DPicture * this, char * param_1);
void J2DPicture__J2DPicture_4(J2DPicture * this, ulong param_1, TBox2__float__ * param_2, ResTIMG * param_3, ResTLUT * param_4);
...
void J2DPicture__J2DPicture_destructor(J2DPicture * this, short flag);
undefined J2DPicture__insert(J2DPicture * this, ResTIMG * param_1, uchar param_2, float param_3);
undefined J2DPicture__insert_1(J2DPicture * this, char * param_1, uchar param_2, float param_3);
int J2DPicture__remove(J2DPicture * this, char * __filename);
undefined J2DPicture__changeTexture(J2DPicture * this, ResTIMG * pImg, byte i);
undefined J2DPicture__changeTexture_1(J2DPicture * this, char * param_1, byte param_2);
undefined J2DPicture__drawSelf(J2DPicture * this, float param_1, float param_2);
undefined J2DPicture__drawSelf_1(J2DPicture * this, float x, float y, float * param_3);
void J2DPicture__drawFullSet(J2DPicture * this, float param_1, J2DBinding binding, J2DMirror mirror, bool param_4, MTX34 * pMtx);
...
undefined J2DPicture__drawOut_2(J2DPicture * this, TBox2__float__ * param_1, TBox2__float__ * param_2);
void J2DPicture__drawTexCoord(J2DPicture * this, MTX34 * param_1);
...
void J2DTextBox__J2DTextBox_1(J2DTextBox * this, J2DPane * param_1, JSURandomInputStream * param_2);
void J2DTextBox__J2DTextBox_2(J2DTextBox * this, ulong param_1, TBox2__float__ * param_2, ResFONT * param_3, char * param_4, J2DTextBoxHBinding param_5, J2DTextBoxVBinding param_6);
...
void J2DTextBox__J2DTextBox_destructor(J2DTextBox * this, short flag);
...
void J2DTextBox__drawSelf_1(J2DTextBox * this, float param_1, float param_2, MTX34 * param_3);
undefined J2DTextBox__resize(J2DTextBox * this, float newX, float newY);
J2DTypeID J2DTextBox__getTypeID(J2DTextBox * this);
...
double J3DGraphBase__J3DCalcZValue(MTX34 * pMtx, cXyz * pPos);
...
undefined J3DGraphBase__J3DGetTranslateRotateMtx_1();
...
undefined J3DDisplayListObj__setSingleDisplayList(J3DDisplayListObj * this, void * pData, ulong size);
...
undefined J3DShapeMtxMultiConcatView__loadNrmMtx_1(J3DShapeMtxMultiConcatView * this, int param_1, ushort param_2);
...
undefined J3DShapeMtxConcatView__loadNrmMtx_1(J3DShapeMtxConcatView * this, int param_1, ushort param_2);
...
undefined J3DPEBlock__setAlphaComp_1(J3DPEBlock * this, J3DAlphaComp * param_1);
undefined J3DPEBlock__setBlend_1(J3DPEBlock * this, J3DBlend * param_1);
undefined J3DPEBlock__setZMode_1(J3DPEBlock * this, J3DZMode * param_1);
undefined J3DPEBlock__setZCompLoc_1(J3DPEBlock * this, uchar * param_1);
undefined J3DPEBlock__setDither(J3DPEBlock * this, uchar param_1);
undefined J3DPEBlock__setDither_1(J3DPEBlock * this, uchar * param_1);
...
undefined J3DIndBlock__setIndTexOrder_1(J3DIndBlock * this, ulong param_1, J3DIndTexOrder param_2);
undefined J3DIndBlock__setIndTexMtx_1(J3DIndBlock * this, ulong param_1, J3DIndTexMtx * param_2);
undefined J3DIndBlock__setIndTexCoordScale_1(J3DIndBlock * this, ulong param_1, J3DIndTexCoordScale * param_2);
undefined J3DTexGenBlock__setTexGenNum_1(J3DTexGenBlock * this, ulong * param_1);
undefined J3DTexGenBlock__setNBTScale(J3DTexGenBlock * this, J3DNBTScale param_1);
undefined J3DTexGenBlock__setNBTScale_1(J3DTexGenBlock * this, J3DNBTScale * param_1);
...
undefined J3DColorBlock__setMatColor_1(J3DColorBlock * this, ulong param_1, J3DGXColor * param_2);
undefined J3DColorBlock__setAmbColor_1(J3DColorBlock * this, ulong param_1, J3DGXColor * param_2);
undefined J3DColorBlock__setColorChanNum_1(J3DColorBlock * this, uchar * param_1);
undefined J3DColorBlock__setColorChan_3(J3DColorBlock * this, ulong param_1, J3DColorChan * param_2);
undefined J3DColorBlock__getLight(J3DColorBlock * this, ulong param_1);
undefined J3DColorBlock__setCullMode_1(J3DColorBlock * this, uchar * param_1);
...
undefined J3DPEBlockFull__setAlphaComp_1(J3DPEBlockFull * this, J3DAlphaComp * param_1);
...
undefined J3DPEBlockFull__setBlend_1(J3DPEBlockFull * this, J3DBlend * param_1);
...
undefined J3DPEBlockFull__setZMode_1(J3DPEBlockFull * this, J3DZMode * param_1);
...
undefined J3DPEBlockFull__setZCompLoc_1(J3DPEBlockFull * this, uchar * param_1);
...
undefined J3DPEBlockFull__setDither_1(J3DPEBlockFull * this, uchar * param_1);
...
undefined J3DPEBlockFogOff__setAlphaComp_1(J3DPEBlockFogOff * this, J3DAlphaComp * param_1);
...
undefined J3DPEBlockFogOff__setBlend_1(J3DPEBlockFogOff * this, J3DBlend * param_1);
...
undefined J3DPEBlockFogOff__setZMode_1(J3DPEBlockFogOff * this, J3DZMode * param_1);
...
undefined J3DPEBlockFogOff__setZCompLoc_1(J3DPEBlockFogOff * this, uchar * param_1);
...
undefined J3DPEBlockFogOff__setDither_1(J3DPEBlockFogOff * this, uchar * param_1);
...
undefined J3DTevBlock16__setTexNo_1(J3DTevBlock16 * this, ulong param_1, ushort * param_2);
...
undefined J3DTevBlock16__setTevOrder_1(J3DTevBlock16 * this, ulong param_1, J3DTevOrder * param_2);
...
undefined J3DTevBlock16__setTevColor_1(J3DTevBlock16 * this, ulong param_1, J3DGXColorS10 * param_2);
...
undefined J3DTevBlock16__setTevKColor_1(J3DTevBlock16 * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DTevBlock16__setTevKColorSel_1(J3DTevBlock16 * this, ulong param_1, uchar * param_2);
...
undefined J3DTevBlock16__setTevKAlphaSel_1(J3DTevBlock16 * this, ulong param_1, uchar * param_2);
...
undefined J3DTevBlock16__setTevStageNum_1(J3DTevBlock16 * this, uchar * param_1);
...
undefined J3DTevBlock16__setTevStage_3(J3DTevBlock16 * this, ulong param_1, undefined param_2);
...
undefined J3DTevBlock16__setTevSwapModeInfo_1(J3DTevBlock16 * this, ulong param_1, J3DTevSwapModeInfo * param_2);
undefined J3DTevBlock16__setTevSwapModeTable(J3DTevBlock16 * this, ulong param_1, J3DTevSwapModeTable param_2);
undefined J3DTevBlock16__setTevSwapModeTable_1(J3DTevBlock16 * this, ulong param_1, J3DTevSwapModeTable * param_2);
...
undefined J3DTevBlock16__setIndTevStage_1(J3DTevBlock16 * this, ulong param_1, J3DIndTevStage * param_2);
...
undefined J3DTevBlock4__setTexNo_1(J3DTevBlock4 * this, ulong param_1, ushort * param_2);
...
undefined J3DTevBlock4__setTevOrder_1(J3DTevBlock4 * this, ulong param_1, J3DTevOrder * param_2);
...
undefined J3DTevBlock4__setTevColor_1(J3DTevBlock4 * this, ulong param_1, J3DGXColorS10 * param_2);
...
undefined J3DTevBlock4__setTevKColor_1(J3DTevBlock4 * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DTevBlock4__setTevKColorSel_1(J3DTevBlock4 * this, ulong param_1, uchar * param_2);
...
undefined J3DTevBlock4__setTevKAlphaSel_1(J3DTevBlock4 * this, ulong param_1, uchar * param_2);
...
undefined J3DTevBlock4__setTevStageNum_1(J3DTevBlock4 * this, uchar * param_1);
...
undefined J3DTevBlock4__setTevStage_3(J3DTevBlock4 * this, ulong param_1, undefined param_2);
...
undefined J3DTevBlock4__setTevSwapModeInfo_1(J3DTevBlock4 * this, ulong param_1, J3DTevSwapModeInfo * param_2);
undefined J3DTevBlock4__setTevSwapModeTable(J3DTevBlock4 * this, ulong param_1, J3DTevSwapModeTable param_2);
undefined J3DTevBlock4__setTevSwapModeTable_1(J3DTevBlock4 * this, ulong param_1, J3DTevSwapModeTable * param_2);
...
undefined J3DTevBlock4__setIndTevStage_1(J3DTevBlock4 * this, ulong param_1, J3DIndTevStage * param_2);
...
undefined J3DTevBlock2__setTexNo_1(J3DTevBlock2 * this, ulong param_1, ushort * param_2);
...
undefined J3DTevBlock2__setTevOrder_1(J3DTevBlock2 * this, ulong param_1, J3DTevOrder * param_2);
...
undefined J3DTevBlock2__setTevColor_1(J3DTevBlock2 * this, ulong param_1, J3DGXColorS10 * param_2);
...
undefined J3DTevBlock2__setTevKColor_1(J3DTevBlock2 * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DTevBlock2__setTevKColorSel_1(J3DTevBlock2 * this, ulong param_1, uchar * param_2);
...
undefined J3DTevBlock2__setTevKAlphaSel_1(J3DTevBlock2 * this, ulong param_1, uchar * param_2);
...
undefined J3DTevBlock2__setTevStageNum_1(J3DTevBlock2 * this, uchar * param_1);
...
undefined J3DTevBlock2__setTevStage_3(J3DTevBlock2 * this, ulong param_1, undefined param_2);
...
undefined J3DTevBlock2__setTevSwapModeInfo_1(J3DTevBlock2 * this, ulong param_1, J3DTevSwapModeInfo * param_2);
undefined J3DTevBlock2__setTevSwapModeTable(J3DTevBlock2 * this, ulong param_1, J3DTevSwapModeTable param_2);
undefined J3DTevBlock2__setTevSwapModeTable_1(J3DTevBlock2 * this, ulong param_1, J3DTevSwapModeTable * param_2);
...
undefined J3DTevBlock2__setIndTevStage_1(J3DTevBlock2 * this, ulong param_1, J3DIndTevStage * param_2);
...
undefined J3DTevBlock1__setTexNo_1(J3DTevBlock1 * this, ulong param_1, ushort * param_2);
...
undefined J3DTevBlock1__setTevOrder_1(J3DTevBlock1 * this, ulong param_1, J3DTevOrder * param_2);
...
undefined J3DTevBlock1__setTevStageNum_1(J3DTevBlock1 * this, uchar * param_1);
...
undefined J3DTevBlock1__setTevStage_3(J3DTevBlock1 * this, ulong param_1, undefined param_2);
...
undefined J3DTevBlock1__setIndTevStage_1(J3DTevBlock1 * this, ulong param_1, J3DIndTevStage * param_2);
...
undefined J3DTevBlock__setTevKColorSel_1(J3DTevBlock * this, ulong param_1, uchar * param_2);
undefined J3DTevBlock__setTevKAlphaSel_1(J3DTevBlock * this, ulong param_1, uchar * param_2);
undefined J3DTevBlock__setTevSwapModeInfo(J3DTevBlock * this, ulong param_1, J3DTevSwapModeInfo param_2);
undefined J3DTevBlock__setTevSwapModeInfo_1(J3DTevBlock * this, ulong param_1, J3DTevSwapModeInfo * param_2);
undefined J3DTevBlock__setTevSwapModeTable_1(J3DTevBlock * this, ulong param_1, J3DTevSwapModeTable * param_2);
...
undefined J3DTevBlockPatched__setTevStageNum_1(J3DTevBlockPatched * this, uchar * param_1);
...
undefined J3DTevBlockPatched__setTexNo_1(J3DTevBlockPatched * this, ulong param_1, ushort * param_2);
...
undefined J3DTevBlockPatched__setTevOrder_1(J3DTevBlockPatched * this, ulong param_1, J3DTevOrder * param_2);
...
undefined J3DTevBlockPatched__setTevStage_3(J3DTevBlockPatched * this, ulong param_1, J3DTevStage * param_2);
...
undefined J3DTevBlockPatched__setIndTevStage_1(J3DTevBlockPatched * this, ulong param_1, J3DIndTevStage * param_2);
...
undefined J3DTevBlockPatched__setTevColor_1(J3DTevBlockPatched * this, ulong param_1, J3DGXColorS10 * param_2);
...
undefined J3DTevBlockPatched__setTevKColor_1(J3DTevBlockPatched * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DTevBlockPatched__setTevKColorSel_1(J3DTevBlockPatched * this, ulong param_1, uchar * param_2);
...
undefined J3DTexGenBlockBasic__setNBTScale_1(J3DTexGenBlockBasic * this, J3DNBTScale * param_1);
...
undefined J3DTexGenBlockPatched__setTexGenNum_1(J3DTexGenBlockPatched * this, ulong * param_1);
...
undefined J3DTexGenBlock4__setNBTScale_1(J3DTexGenBlock4 * this, J3DNBTScale * param_1);
...
undefined J3DColorBlockLightOn__setMatColor_1(J3DColorBlockLightOn * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DColorBlockLightOn__setAmbColor_1(J3DColorBlockLightOn * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DColorBlockLightOn__setColorChanNum_1(J3DColorBlockLightOn * this, uchar param_1);
...
undefined J3DColorBlockLightOn__setColorChan_3(J3DColorBlockLightOn * this, ulong param_1, J3DColorChan * param_2);
...
undefined J3DColorBlockLightOn__setCullMode_1(J3DColorBlockLightOn * this, uchar * param_1);
...
undefined J3DColorBlockAmbientOn__setAmbColor_1(J3DColorBlockAmbientOn * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DColorBlockLightOff__setMatColor_1(J3DColorBlockLightOff * this, ulong param_1, J3DGXColor * param_2);
...
undefined J3DColorBlockLightOff__setColorChanNum_1(J3DColorBlockLightOff * this, uchar param_1);
...
undefined J3DColorBlockLightOff__setColorChan_3(J3DColorBlockLightOff * this, ulong param_1, J3DColorChan * param_2);
...
undefined J3DColorBlockLightOff__setCullMode_1(J3DColorBlockLightOff * this, uchar * param_1);
...
undefined J3DIndBlockFull__setIndTexOrder_1(J3DIndBlockFull * this, ulong param_1, J3DIndTexOrder * param_2);
...
undefined J3DIndBlockFull__setIndTexMtx_1(J3DIndBlockFull * this, ulong param_1, J3DIndTexMtx * param_2);
...
undefined J3DIndBlockFull__setIndTexCoordScale_1(J3DIndBlockFull * this, ulong param_1, J3DIndTexCoordScale * param_2);
...
undefined J3DTevBlock__setTexNo_2(J3DTevBlock * this, ulong param_1, ushort * param_2);
undefined J3DTevBlock__setTevOrder_1(J3DTevBlock * this, ulong param_1, J3DTevOrder * param_2);
undefined J3DTevBlock__setTevStageNum_1(J3DTevBlock * this, uchar * param_1);
undefined J3DTevBlock__setTevStage_3(J3DTevBlock * this, ulong param_1, undefined param_2);
undefined J3DTevBlock__setIndTevStage_1(J3DTevBlock * this, ulong param_1, J3DIndTevStage * param_2);
...
undefined J3DDrawBuffer__entryImm(J3DDrawBuffer * this, J3DPacket * pPacket, ushort index);
...
undefined J3DAnmColor__searchUpdateMaterialID_1(J3DAnmColor * this, J3DModelData * param_1);
...
undefined J3DAnmTexPattern__searchUpdateMaterialID_1(J3DAnmTexPattern * this, J3DModelData * param_1);
undefined J3DAnmTextureSRTKey__searchUpdateMaterialID(J3DAnmTextureSRTKey * this, J3DMaterialTable * param_1);
undefined J3DAnmTextureSRTKey__searchUpdateMaterialID_1(J3DAnmTextureSRTKey * this, J3DModelData * param_1);
...
undefined J3DAnmTevRegKey__searchUpdateMaterialID_1(J3DAnmTevRegKey * this, J3DModelData * param_1);
...
undefined J3DGraphAnimator__J3DGetKeyFrameInterpolation_2();
...
double J3DAnmCluster__getWeight(J3DAnmCluster * this, ushort param_1);
...
undefined J3DVisibilityManager__setVisibility(J3DVisibilityManager * this, J3DModelData * pModel);
...
undefined J3DDeformData__deform_1(J3DDeformData * this, J3DVertexBuffer * pBuffer);
...
undefined J3DDeformer__deform_1(J3DDeformer * this, J3DVertexBuffer * param_1, ushort param_2, float * param_3);
...
undefined J3DMtxCalcBasic__recursiveCalc_4(J3DMtxCalcBasic * this, J3DNode * param_1);
...
undefined J3DMtxCalcMaya__calcTransform_4(J3DMtxCalcMaya * this, ushort param_1, J3DTransformInfo * param_2);
...
undefined J3DMtxCalcAnm__calc_1(J3DMtxCalcAnm * this, ushort param_1);
undefined J3DMtxCalcBasic__calcTransform_1(J3DMtxCalcBasic * this, ushort param_1, J3DTransformInfo * param_2);
int J3DMtxCalcBasic__init_1(J3DMtxCalcBasic * this, cXyz * param_1, MTX34 * param_2);
undefined J3DMtxCalcSoftimage__calcTransform_1(J3DMtxCalcSoftimage * this, ushort param_1, J3DTransformInfo * param_2);
int J3DMtxCalcSoftimage__init_1(J3DMtxCalcSoftimage * this, EVP_PKEY_CTX * ctx);
undefined J3DMtxCalcBasic__calc_3(J3DMtxCalcBasic * this, ushort param_1);
undefined J3DMtxCalcMaya__calcTransform_5(J3DMtxCalcMaya * this, ushort param_1, J3DTransformInfo * param_2);
undefined J3DMtxCalcBasic__recursiveCalc_5(J3DMtxCalcBasic * this, J3DNode * param_1);
int J3DMtxCalcMaya__init_5(J3DMtxCalcMaya * this, EVP_PKEY_CTX * ctx);
...
void J3DMaterialFactory__J3DMaterialFactory_1(J3DMaterialFactory * this, J3DMaterialDLBlock * param_1);
...
void J3DTevStage__J3DTevStage_1(J3DTevStage * this, J3DTevStageInfo * param_1);
void J3DMaterial__J3DMaterial_destructor(J3DMaterial * this);
undefined J3DGraphLoader__JSUConvertOffsetToPtr();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_1();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_2();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_3();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_4();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_5();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_6();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_7();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_8();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_9();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_10();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_11();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_12();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_13();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_14();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_15();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_16();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_17();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_18();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_19();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_20();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_21();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_22();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_23();
...
undefined J3DGraphLoader__JSUConvertOffsetToPtr_24();
...
undefined J3DGraphLoader__JSUConvertOffsetToPtr_25();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_26();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_27();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_28();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_29();
...
undefined J3DGraphLoader__JSUConvertOffsetToPtr_30();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_31();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_32();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_33();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_34();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_35();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_36();
...
undefined J3DGraphLoader__JSUConvertOffsetToPtr_37();
...
undefined J3DGraphLoader__JSUConvertOffsetToPtr_38();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_39();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_40();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_41();
undefined4 J3DAnmLoaderDataBase__load(void * pData);
...
undefined J3DGraphLoader__JSUConvertOffsetToPtr_42();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_43();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_44();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_45();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_46();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_47();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_48();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_49();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_50();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_51();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_52();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_53();
undefined J3DGraphLoader__JSUConvertOffsetToPtr_54();
undefined JKernel__JMath__JMANewSinTable();
void JKernel__JMath__JMAEulerToQuat(int param_1, int param_2, int param_3, Quaternion * pDst);
undefined JKernel__JMath__JMAQuatLerp();
undefined JKernel__JMath__JMAHermiteInterpolation();
void JKernel__JMath__TRandom_fast___TRandom_fast_(TRandom_fast_ * this, ulong param_1);
undefined JKernel__JMath__TRandom_enough___setSeed(TRandom_enough_ * this, ulong param_1);
undefined JKernel__JMath__TRandom_enough___get(TRandom_enough_ * this);
...
undefined os__OSLinkFixed(DynamicModule * pRel, void * pBSS);
undefined os__Undo();
...
undefined os__OSLockMutex(OSMutex * param_1);
undefined os__OSUnlockMutex(OSMutex * pMutex);
...
undefined exi__EXIImmEx(int card_slot, undefined4 param_2, undefined4 param_3, undefined4 param_4);
...
undefined exi__EXIProbeEx(undefined4 card_slot);
...
int dvd__DVDConvertPathToEntrynum(char * filePath);
undefined dvd__DVDFastOpen();
bool dvd__DVDOpen(char * param_1, int param_2);
...
undefined dvd__DVDReadPrio(DVDFileInfo * pFileInfo, void * pDst, undefined4 size, undefined4 offs, int prio);
undefined dvd__cbForReadSync();
bool dvd__DVDOpenDir(char * param_1, int * param_2);
...
undefined card____CARDExtHandler(undefined4 card_slot);
undefined card____CARDExiHandler();
undefined card____CARDTxHandler();
undefined card____CARDUnlockedHandler();
card_errors card____CARDEnableInterrupt(undefined4 param_1, int param_2);
card_errors card____CARDReadStatus(undefined4 param_1, undefined4 param_2);
card_errors card____CARDClearStatus(undefined4 param_1);
undefined card__TimeoutHandler();
undefined card__Retry();
undefined card__UnlockedCallback();
card_errors card____CARDStart(undefined4 card_slot, void * read_callback, undefined4 ext_handler);
undefined card____CARDReadSegment(undefined4 card_slot, void * read_callback);
undefined card____CARDWritePage(undefined4 card_slot, undefined4 param_2);
undefined card____CARDEraseSector(undefined4 card_slot, undefined4 len, void * ext_handler);
card_errors card__CARDInit(void);
undefined card____CARDGetFontEncode();
undefined card____CARDSetDiskID();
card_errors card____CARDGetControlBlock(int card_slot, CardBlockData * * param_2);
card_errors card____CARDPutControlBlock(CardBlockData * param_1, card_errors param_2);
undefined card__CARDFreeBlocks(int card_slot, CARDFileInfo * param_2, undefined4 out__card_block_count);
card_errors card____CARDSync(undefined4 card_slot);
card_errors card__OnReset(int param_1);
undefined card__bitrev();
card_errors card__ReadArrayUnlock(int param_1, uint param_2, undefined4 param_3, undefined4 param_4, int param_5);
...
card_errors card____CARDRead(int card_slot, uint len, uint offset, void * buffer, void * read_cb);
undefined card__BlockWriteCallback();
card_errors card____CARDWrite(undefined4 card_slot, undefined4 len, undefined4 offset, undefined4 buffer, undefined4 callback);
undefined card____CARDGetFatBlock(CardBlockData * param_1);
undefined card__WriteCallback();
undefined card__EraseCallback();
card_errors card____CARDAllocBlock(int card_slot, uint size);
undefined card____CARDUpdateFatBlock(undefined4 card_slot, undefined4 param_2, undefined4 param_3);
card_direntry * card____CARDGetDirBlock(CardBlockData * param_1);
undefined card__WriteCallback_1();
undefined card__EraseCallback_1();
card_errors card____CARDUpdateDir(int card_slot, void * callback);
undefined card____CARDCheckSum();
card_errors card__VerifyID(int param_1);
undefined card__VerifyDir();
undefined card__VerifyFAT();
undefined card____CARDVerify();
undefined card__CARDCheckExAsync();
card_errors card__CARDCheck(int card_slot);
bool card__IsCard(undefined1 * param_1);
card_errors card__CARDProbe(int card_slot);
card_errors card__CARDProbeEx(int card_slot, uint * mem_size, uint * sect_size);
undefined card__DoMount();
undefined card____CARDMountCallback();
card_errors card__CARDMountAsync(undefined4 card_slot, void * workarea, int detach_cb, undefined4 attach_cb);
card_errors card__CARDMount(int card_slot, void * workarea, int detatch_cb);
undefined card__DoUnmount();
card_errors card__CARDUnmount(undefined4 card_slot);
undefined card__FormatCallback();
undefined card____CARDFormatRegionAsync(undefined4 card_slot, undefined2 param_2, undefined4 attach_cb);
card_errors card__CARDFormat(int card_slot);
bool card____CARDCompareFileName(card_file_header * file_header, char * filename);
card_errors card____CARDAccess(CardBlockData * param_1, card_direntry * param_2);
card_errors card____CARDIsPublic(card_direntry * param_1);
card_errors card__CARDOpen(int card_slot, char * filename, CARDFileInfo * file);
card_errors card__CARDClose(CARDFileInfo * card_slot);
undefined card__CreateCallbackFat(undefined4 card_slot, undefined4 card_status);
card_errors card__CARDCreateAsync(int card_slot, undefined4 filename, undefined4 size, CARDFileInfo * file, undefined4 callback);
card_errors card__CARDCreate(int card_slot, char * filename, int size, CARDFileInfo * file);
card_errors card____CARDSeek(CARDFileInfo * file, int len, uint offset, CardBlockData * * param_4);
undefined card__ReadCallback();
card_errors card__CARDReadAsync(CARDFileInfo * file, void * buffer, uint len, uint offset, void * callback);
card_errors card__CARDRead(CARDFileInfo * file, void * buffer, uint len, uint offset);
undefined card__WriteCallback_2();
undefined card__EraseCallback_2();
card_errors card__CARDWriteAsync(CARDFileInfo * file, void * buffer, undefined4 len, undefined4 offset, undefined4 callback);
card_errors card__CARDWrite(undefined4 file, undefined4 buffer, uint len, uint offset);
undefined card__UpdateIconOffsets(card_direntry * param_1, card_status * stats);
undefined card__CARDGetStatus(int card_slot, undefined4 fileno, card_status * stats);
card_errors card__CARDSetStatusAsync(int card_slot, int fileno, card_status * status, void * callback);
card_errors card__CARDSetStatus(int card_slot, int fileno, card_status * stats);
undefined card__CARDGetSerialNo(undefined4 card_slot, uint * param_2);
...
void gx__GXSetTexCoordGen2(GXTexCoordID dst_coord, GXTexGenType func, GXTexGenSrc src_param, GXTexMtx mtx, bool normalize, GXPTTexMtx postmtx);
void gx__GXSetNumTexGens(uint param_1);
...
void gx__GXInitLightAttn(_GXLightObj * param_1, double param_2, double param_3, double param_4, double param_5, double param_6, double param_7);
...
void gx__GXSetNumIndStages(int param_1);
...
undefined gx__GXLoadTexMtxImm(undefined4 param_1, GXTexMtx param_2, undefined4 param_3);
