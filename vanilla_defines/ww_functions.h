...
undefined card____CARDSync(undefined4 card_slot);
...
undefined card__CARDClose(int card_slot);
undefined card__CARDCreate(int card_slot);
undefined card__CARDCreateAsync();
undefined card__CARDFormat(int card_slot);
...
void card__CARDMount(s32 card_slot, void * workarea, int detatch_cb);
int card__CARDMountAsync(undefined4 card_slot, void * workarea, int detach_cb, undefined4 attach_cb);
int card__CARDOpen(int card_slot, char * filename, card_file * file);
int card__CARDProbe(int card_slot);
int card__CARDProbeEx(int card_slot, uint * mem_size, uint * sect_size);
undefined card__CARDRead(card_file * file);
undefined card__CARDReadAsync();
int card__CARDSetStatus(int card_slot, int fileno, card_stat * stats);
undefined card__CARDSetStatusAsync();
undefined card__CARDUnmount(undefined4 card_slot);
undefined card__CARDWrite(undefined4 file, undefined4 buffer, uint len, uint offset);
undefined card__CARDWriteAsync(card_file * file, void * buffer, undefined4 len, undefined4 offset, undefined4 callback);
