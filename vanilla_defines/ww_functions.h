...
card_errors card____CARDPutControlBlock(int * param_1, card_errors param_2);
card_errors card____CARDRead(int param_1, undefined4 param_2, uint param_3, undefined4 param_4, undefined4 param_5);
undefined card____CARDReadSegment();
undefined card____CARDReadStatus();
card_errors card____CARDSeek(undefined4 * param_1, int param_2, uint param_3, int * param_4);
...
card_errors card__CARDClose(int card_slot);
...
int card__CARDMount(int card_slot, void * workarea, int detatch_cb);
int card__CARDMountAsync(undefined4 card_slot, void * workarea, int detach_cb, undefined4 attach_cb);
...
card_errors card__CARDReadAsync(card_file * param_1, void * buffer, uint len, uint offset, int callback);
