...
undefined fopAcM_searchActorDistanceXZ(fopAc_ac_c * param_1, fopAc_ac_c * param_2);
...
undefined4 f_pc_load__fpcLd_Load(ushort param_1);
...
JntHit_c * d_jnt_hit__JntHit_create(J3DModel * param_1, __jnt_hit_data_c * param_2, short param_3);
...
undefined daPy_swBlur_c__initSwBlur(daPy_swBlur_c * this, MTX34 * param_1, int param_2, float param_3, int param_4);
...
int JKRHeap__getSize(JKRHeap * this, void * param_1, JKRHeap * param_2);
...
undefined JKRHeap__find(JKRHeap * this, void * pPtr);
...
undefined JKRAramArchive__fetchResource_subroutine_1(JKRAramArchive * this, ulong param_1, ulong param_2, JKRHeap * param_3, int param_4, uchar * * param_5);
...
undefined JKRDvdArchive__fetchResource_subroutine_1(JKRDvdArchive * this, long param_1, ulong param_2, ulong param_3, JKRHeap * param_4, int param_5, int param_6, uchar * * param_7);
...
undefined JKRCompArchive__fetchResource_1(JKRCompArchive * this, void * param_1, ulong param_2, SDIFileEntry * param_3, ulong * param_4);
...
int JKRDvdFile__open_1(JKRDvdFile * this, char * __file, int __oflag, ...);
...
JKRArchive__Header * JKRDvdRipper__loadToMainRAM_1(long param_1, uchar * param_2, JKRExpandSwitch param_3, ulong param_4, JKRHeap * param_5, EAllocDirection param_6, ulong param_7, int * param_8);
undefined JKRDvdRipper__loadToMainRAM_2(JKRDvdFile * param_1, uchar * param_2, JKRExpandSwitch param_3, ulong param_4, JKRHeap * param_5, EAllocDirection param_6, ulong param_7, int * outCompType);
undefined JKernel__JKRDecompressFromDVD();
undefined JKernel__decompSZS_subroutine_1();
undefined JKernel__firstSrcData_1();
...
undefined JKRDvdAramRipper__loadToAram_1(JKRDvdAramRipper * this, JKRDvdFile * param_1, ulong param_2, JKRExpandSwitch param_3, ulong param_4, ulong param_5);
...
undefined JKernel__decompSZS_subroutine_2();
undefined JKernel__firstSrcData_2();
undefined JKernel__nextSrcData_2();
