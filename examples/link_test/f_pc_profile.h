...
namespace f_pc_profile {
  ...
  struct profile_leaf_method_class {
    /* 0x00 */ int (* mpCreate)(dDlst_derive_c*); // 0x04 bytes
    /* 0x04 */ int (* mpDelete)(dDlst_derive_c*); // 0x04 bytes
    /* 0x08 */ int (* mpExecute)(dDlst_derive_c*); // 0x04 bytes
    /* 0x0C */ int (* mpIsDelete)(dDlst_derive_c*); // 0x04 bytes
    /* 0x10 */ int (* mpDraw)(dDlst_derive_c*); // 0x04 bytes
  };
