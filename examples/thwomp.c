...
int daThwomp_Execute(THWOMP_class* this) {
  // Move the entity.
  cXyz* dest_pos = &g_dComIfG_gameInfo.mPlay.mpCurPlayerActor[0]->parent.parent.mNext.mPos;
  ...
  short yRotDiff = fopAcM_searchActorAngleY(&this->parent, &g_dComIfG_gameInfo.mPlay.mpCurPlayerActor[0]->parent.parent);
