...
py build_rel.py "./examples/npc_test.c" 0x58 g_profile_NPC_Test --rels_arc "../Random Seeds/WW Random EnemyRandoTest/files/RELS.arc" --md5_check 4f5f2b54a4b10b7f73d9790e6cfa7ee2
if %errorlevel% neq 0 exit /b %errorlevel%
